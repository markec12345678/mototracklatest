...
const SAMPLE_LOCATIONS = [
  {
    id: 'bd-coca',
    name: 'Coca-Cola Consolidated Distribution Center Charlotte NC',
    lat: 35.2271,
    lng: -80.8431,
    status: 'stable',
    value: 94,
    ...
    monthlyRevenue: 8.4,
    skusInStock: 1200,
    flagshipLines: 'Coca-Cola, Sprite, Dasani, Smartwater',
    trend: 'up' as const,
    description: 'Largest independent Coca-Cola bottler in the US',
  },
  {
    id: 'bd-pepsi',
    name: 'Pepsi Bottling Group Distribution Center Somers NY',
    lat: 41.3282,
    lng: -73.719,
    status: 'stable',
    value: 90,
    ...
    monthlyRevenue: 7.2,
    skusInStock: 980,
    flagshipLines: 'Pepsi, Mountain Dew, Gatorade, Tropicana',
    trend: 'up' as const,
    description: 'Major PepsiCo distribution hub serving the Northeast',
  },
  {
    id: 'bd-anheuser',
    name: 'Anheuser-Busch Distributor Newark NJ',
    lat: 40.7324,
    lng: -74.1857,
    status: 'moderate',
    value: 80,
    ...
    monthlyRevenue: 5.8,
    skusInStock: 720,
    flagshipLines: 'Budweiser, Michelob, Stella, Corona',
    trend: 'flat' as const,
    description: 'Regional beer distributor serving NYC metro',
  },
  {
    id: 'bd-monster',
    name: 'Monster Beverage Distribution Corona CA',
    lat: 33.8753,
    lng: -117.5657,
    status: 'warning',
    value: 70,
    ...
    monthlyRevenue: 3.2,
    skusInStock: 480,
    flagshipLines: 'Monster Energy, Reign, Full Throttle',
    trend: 'down' as const,
    description: 'Energy drink distribution warehouse for West Coast',
  },
]
...
export function BeverageDistributionCenterMonitor() {
  const state = useMapStore((s) => s.beverageDistributionCenter)
  const setState = useMapStore((s) => s.setBeverageDistributionCenter)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-cyan-700 to-teal-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Beverage Distribution Center</h3>
        </div>
