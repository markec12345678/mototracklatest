...
const SAMPLE_LOCATIONS = [
  {
    id: 'cr-starbucks',
    name: 'Starbucks Reserve Roastery Seattle WA',
    lat: 47.612,
    lng: -122.334,
    status: 'stable',
    value: 95,
    ...
    monthlyRevenue: 4.8,
    skusInStock: 280,
    flagshipLines: 'Starbucks Reserve, Single-Origin, Nitro Cold Brew',
    trend: 'up' as const,
    description: 'Starbucks Reserve Roastery Seattle WA flagship, 1,240 daily customers with 280 SKUs of small-lot coffees; experiential roastery and tasting room',
  },
  {
    id: 'cr-blue-bottle',
    name: 'Blue Bottle Coffee Oakland CA HQ',
    lat: 37.804,
    lng: -122.271,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 220,
    flagshipLines: 'Blue Bottle, Bella Donovan, Three Africas, Giant Steps',
    trend: 'stable' as const,
    description: 'Blue Bottle Coffee Oakland CA HQ roastery cafe, 380 daily customers with 220 SKUs; specialty coffee pioneer with single-origin focus',
  },
  {
    id: 'cr-stumptown',
    name: 'Stumptown Coffee Portland OR',
    lat: 45.516,
    lng: -122.679,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 1.1,
    skusInStock: 180,
    flagshipLines: 'Stumptown, Hair Bender, Holler Mountain, French Roast',
    trend: 'stable' as const,
    description: 'Stumptown Coffee Portland OR flagship roastery, 320 daily customers with 180 SKUs; direct-trade coffee innovator acquired by Peets',
  },
  {
    id: 'cr-philz',
    name: 'Philz Coffee San Francisco CA',
    lat: 37.760,
    lng: -122.435,
    status: 'warning',
    value: 64,
    ...
    monthlyRevenue: 0.78,
    skusInStock: 140,
    flagshipLines: 'Philz, Mint Mojito, Jacob, Tesora, Philtered Soul',
    trend: 'down' as const,
    description: 'Philz Coffee San Francisco CA flagship, 240 daily customers with 140 SKUs; pour-over specialty chain facing labor cost pressure',
  },
]
...
export function CoffeeRoasterCafeMonitor() {
  const state = useMapStore((s) => s.coffeeRoasterCafe)
  const setState = useMapStore((s) => s.setCoffeeRoasterCafe)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-700 to-yellow-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Coffee Roaster &amp; Cafe</h3>
        </div>
