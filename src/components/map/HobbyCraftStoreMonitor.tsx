...
const SAMPLE_LOCATIONS = [
  {
    id: 'hc-michaels',
    name: 'Michaels Stores Irving TX HQ',
    lat: 32.814,
    lng: -96.949,
    status: 'stable',
    value: 89,
    ...
    monthlyRevenue: 3.8,
    skusInStock: 42000,
    flagshipLines: 'Arts & Crafts, Framing, Floral',
    trend: 'up' as const,
    description: 'Michaels Stores Irving TX HQ flagship, 1,850 daily customers with 42K SKUs across arts, crafts, framing and floral',
  },
  {
    id: 'hc-hobbylobby',
    name: 'Hobby Lobby Oklahoma City OK HQ',
    lat: 35.468,
    lng: -97.521,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 3.2,
    skusInStock: 65000,
    flagshipLines: 'Home Decor, Fabrics, Seasonal',
    trend: 'stable' as const,
    description: 'Hobby Lobby Oklahoma City OK HQ, 1,420 daily customers with 65K SKUs — known for large format stores and seasonal decor',
  },
  {
    id: 'hc-joann',
    name: 'Joann Stores Hudson OH HQ',
    lat: 41.240,
    lng: -81.441,
    status: 'warning',
    value: 62,
    ...
    monthlyRevenue: 1.9,
    skusInStock: 38000,
    flagshipLines: 'Fabrics, Sewing, Quilting',
    trend: 'down' as const,
    description: 'Joann Stores Hudson OH HQ, 980 daily customers — restructuring under Chapter 11; 38K SKUs focused on fabrics and sewing',
  },
  {
    id: 'hc-blick',
    name: 'Blick Art Materials Chicago IL',
    lat: 41.878,
    lng: -87.630,
    status: 'moderate',
    value: 74,
    ...
    monthlyRevenue: 0.85,
    skusInStock: 28000,
    flagshipLines: 'Fine Art, Professional Supplies',
    trend: 'stable' as const,
    description: 'Blick Art Materials Chicago IL flagship, 320 daily customers with 28K SKUs serving professional artists and students',
  },
]
...
export function HobbyCraftStoreMonitor() {
  const state = useMapStore((s) => s.hobbyCraftStore)
  const setState = useMapStore((s) => s.setHobbyCraftStore)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-teal-500 to-cyan-700">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Hobby Craft Store</h3>
        </div>
          ...
          {filteredData.map((loc: any) => (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 flex-shrink-0">
                <span className="text-xs text-slate-300">{(loc.skusInStock / 1000).toFixed(0)}K SKU</span>
