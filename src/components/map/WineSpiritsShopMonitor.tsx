...
const SAMPLE_LOCATIONS = [
  {
    id: 'ws-total-wine',
    name: 'Total Wine & More Phoenix AZ Flagship',
    lat: 33.503,
    lng: -112.034,
    status: 'stable',
    value: 92,
    ...
    monthlyRevenue: 3.4,
    skusInStock: 8400,
    flagshipLines: 'Kendall-Jackson, Caymus, La Crema, Belvedere, Don Julio',
    trend: 'up' as const,
    description: 'Total Wine & More Phoenix AZ superstore, 780 daily customers with 8,400 SKUs of wine spirits and beer; largest US fine wine retailer',
  },
  {
    id: 'ws-bevmo',
    name: 'BevMo! Concord CA HQ',
    lat: 37.978,
    lng: -122.031,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 2.4,
    skusInStock: 6200,
    flagshipLines: 'BevMo, Jackson Family, Silver Oak, Patron, Jack Daniel',
    trend: 'stable' as const,
    description: 'BevMo! Concord CA HQ flagship, 540 daily customers with 6,200 SKUs; West Coast beverage superstore chain with club loyalty program',
  },
  {
    id: 'ws-abc-fine',
    name: 'ABC Fine Wine & Spirits Orlando FL',
    lat: 28.538,
    lng: -81.379,
    status: 'moderate',
    value: 71,
    ...
    monthlyRevenue: 1.6,
    skusInStock: 4800,
    flagshipLines: 'ABC Private, Josh, Whispering Angel, Bulleit',
    trend: 'stable' as const,
    description: 'ABC Fine Wine & Spirits Orlando FL flagship, 410 daily customers with 4,800 SKUs; Florida family-owned wine and spirits leader since 1936',
  },
  {
    id: 'ws-specs',
    name: "Spec's Wines Austin TX",
    lat: 30.267,
    lng: -97.743,
    status: 'warning',
    value: 62,
    ...
    monthlyRevenue: 1.1,
    skusInStock: 3900,
    flagshipLines: 'Specs, Tito, Llano, Duchman, William Chris',
    trend: 'down' as const,
    description: 'Specs Wines Austin TX store, 290 daily customers with 3,900 SKUs; Texas-based spirits retailer facing margin compression on premium tequila',
  },
]
...
export function WineSpiritsShopMonitor() {
  const state = useMapStore((s) => s.wineSpiritsShop)
  const setState = useMapStore((s) => s.setWineSpiritsShop)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-rose-700 to-red-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Wine &amp; Spirits Shop</h3>
        </div>
