...
const SAMPLE_LOCATIONS = [
  {
    id: 'ch-losangeles',
    name: 'Chiropractic Wellness Los Angeles Cafe',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 78,
    ...
    trend: 'up' as const,
    description: 'Chiropractic Wellness Los Angeles cafe serving West Hollywood spinal adjustment clients',
  },
  {
    id: 'ch-newyork',
    name: 'Chiropractic Wellness New York Cafe',
    lat: 40.728,
    lng: -74.001,
    status: 'stable',
    value: 80,
    ...
    description: 'Chiropractic Wellness New York cafe serving Manhattan spinal adjustment clients',
  },
  {
    id: 'ch-chicago',
    name: 'Chiropractic Wellness Chicago Cafe',
    lat: 41.878,
    lng: -87.63,
    status: 'moderate',
    value: 68,
    ...
    trend: 'up' as const,
    description: 'Chiropractic Wellness Chicago cafe serving Loop district spinal adjustment clients',
  },
  {
    id: 'ch-dallas',
    name: 'Chiropractic Wellness Dallas Cafe',
    lat: 32.778,
    lng: -96.799,
    status: 'warning',
    value: 58,
    ...
    trend: 'down' as const,
    description: 'Chiropractic Wellness Dallas cafe serving Uptown spinal adjustment clients',
  },
]
...
export function ChiropracticWellnessCafeMonitor() {
  const state = useMapStore((s) => s.chiropracticWellnessCafe)
  const setState = useMapStore((s) => s.setChiropracticWellnessCafe)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-500 to-orange-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Chiropractic Wellness Cafe</h3>
        </div>
