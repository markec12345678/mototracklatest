...
const SAMPLE_LOCATIONS = [
  {
    id: 'js-miami',
    name: 'Miami Beach Jet Ski Snack Bar, Miami Beach FL',
    lat: 25.791,
    lng: -80.13,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 0.9,
    skusInStock: 88,
    flagshipLines: 'Tacos, Margaritas, Soda, Water',
    trend: 'up' as const,
    description: 'South Beach jet ski rental snack bar serving Biscayne Bay riders',
  },
  {
    id: 'js-lakehavasu',
    name: 'Lake Havasu Jet Ski Snack Bar, Lake Havasu City AZ',
    lat: 34.487,
    lng: -114.322,
    status: 'stable',
    value: 82,
    ...
    monthlyRevenue: 0.8,
    skusInStock: 80,
    flagshipLines: 'Burgers, Beer, Soda, Water',
    trend: 'stable' as const,
    description: 'Lake Havasu jet ski rental snack bar serving Colorado River riders',
  },
  {
    id: 'js-mylrtlebeach',
    name: 'Myrtle Beach Jet Ski Snack Bar, Myrtle Beach SC',
    lat: 33.689,
    lng: -78.887,
    status: 'moderate',
    value: 74,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 72,
    flagshipLines: 'Hot Dogs, Beer, Soda, Snacks',
    trend: 'up' as const,
    description: 'Myrtle Beach jet ski rental snack bar serving Grand Strand riders',
  },
  {
    id: 'js-tahoe',
    name: 'Lake Tahoe Jet Ski Snack Bar, South Lake Tahoe CA',
    lat: 38.939,
    lng: -119.977,
    status: 'warning',
    value: 66,
    ...
    monthlyRevenue: 0.6,
    skusInStock: 65,
    flagshipLines: 'Sandwiches, Coffee, Soda, Water',
    trend: 'down' as const,
    description: 'Lake Tahoe jet ski rental snack bar serving alpine lake riders',
  },
]
...
export function JetSkiRentalSnackBarMonitor() {
  const state = useMapStore((s) => s.jetSkiRentalSnackBar)
  const setState = useMapStore((s) => s.setJetSkiRentalSnackBar)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-orange-500 to-rose-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#128674;</span>
          <h3 className="text-sm font-semibold text-white">Jet Ski Rental Snack Bar</h3>
        </div>
