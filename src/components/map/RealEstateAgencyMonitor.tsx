...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 0.78,
    skusInStock: 28,
    flagshipLines: 'Residential Sales,Commercial,Property Mgmt,Rentals',
    trend: 'up' as const,
    description: 'Related Group Miami FL Brickell headquarters, 47 daily showings with 28 listing categories; dominant condo developer-broker in South Florida',
  },
  {
    id: 're-austin',
    name: 'Keller Williams Austin TX',
    lat: 30.267,
    lng: -97.743,
    status: 'stable',
    value: 82,
    ...
    flagshipLines: 'Residential Sales,Commercial,Property Mgmt,Rentals',
    trend: 'up' as const,
    description: 'Keller Williams Austin TX flagship market center, 56 daily showings with 26 listing categories; largest US franchise by agent count',
  },
  {
    id: 're-denver',
    name: 'RE/MAX Denver CO',
    lat: 39.739,
    lng: -104.99,
    status: 'moderate',
    value: 67,
    ...
    monthlyRevenue: 0.45,
    skusInStock: 19,
    flagshipLines: 'Residential Sales,Commercial,Luxury,Relocation',
    trend: 'stable' as const,
    description: 'RE/MAX Denver CO regional hub, 33 daily showings with 19 listing categories; Mountain West inventory tightness softening volume',
  },
  {
    id: 're-seattle',
    name: 'Windermere Seattle WA',
    lat: 47.606,
    lng: -122.332,
    status: 'warning',
    value: 58,
    ...
    flagshipLines: 'Residential Sales,Commercial,Property Mgmt,Rentals',
    trend: 'down' as const,
    description: 'Windermere Seattle WA flagship office, 22 daily showings with 15 listing categories; Puget Sound buyer demand cooling on rate pressure',
  },
]
...
export function RealEstateAgencyMonitor() {
  const state = useMapStore((s) => s.realEstateAgency)
  const setState = useMapStore((s) => s.setRealEstateAgency)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-orange-600 to-amber-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Real Estate Agency</h3>
        </div>
