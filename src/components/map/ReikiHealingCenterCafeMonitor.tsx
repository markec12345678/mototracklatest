...
const SAMPLE_LOCATIONS = [
  {
    id: 'rk-losangeles',
    name: 'Reiki Healing Center Los Angeles Cafe',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 0.4,
    skusInStock: 38,
    flagshipLines: 'Herbal Tea,Sparkling Water,Energy Bars,Snacks',
    trend: 'up' as const,
    description: 'Reiki Healing Center Los Angeles cafe serving West Hollywood energy healing clients',
  },
  {
    id: 'rk-newyork',
    name: 'Reiki Healing Center New York Cafe',
    lat: 40.728,
    lng: -74.001,
    status: 'moderate',
    value: 72,
    ...
    monthlyRevenue: 0.5,
    skusInStock: 45,
    flagshipLines: 'Espresso,Herbal Tea,Energy Bars,Snacks',
    trend: 'stable' as const,
    description: 'Reiki Healing Center New York cafe serving Manhattan energy healing clients',
  },
  {
    id: 'rk-sedona',
    name: 'Sedona Reiki Healing Center Cafe',
    lat: 34.87,
    lng: -111.761,
    status: 'stable',
    value: 80,
    ...
    monthlyRevenue: 0.5,
    skusInStock: 42,
    flagshipLines: 'Herbal Tea,Kombucha,Energy Bars,Snacks',
    trend: 'up' as const,
    description: 'Sedona Reiki Healing Center cafe serving red rock vortex energy healing clients',
  },
  {
    id: 'rk-portland',
    name: 'Portland Reiki Healing Center Cafe',
    lat: 45.505,
    lng: -122.685,
    status: 'warning',
    value: 58,
    ...
    trend: 'down' as const,
    description: 'Portland Reiki Healing Center cafe serving Hawthorne District energy healing clients',
  },
]
...
export function ReikiHealingCenterCafeMonitor() {
  const state = useMapStore((s) => s.reikiHealingCenterCafe)
  const setState = useMapStore((s) => s.setReikiHealingCenterCafe)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-fuchsia-500 to-purple-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#10024;</span>
          <h3 className="text-sm font-semibold text-white">Reiki Healing Center Cafe</h3>
        </div>
