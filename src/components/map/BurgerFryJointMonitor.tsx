...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 7.8,
    skusInStock: 140,
    flagshipLines: 'Big Mac, Quarter Pounder, McNuggets, Fries, McMuffin',
    trend: 'up' as const,
    description: 'McDonalds Chicago IL HQ flagship Rock N Roll McDonalds, 2,200 daily customers with 140 SKUs; global burger chain leader with all-day breakfast',
  },
  {
    id: 'bf-bk',
    name: 'Burger King Miami FL HQ',
    lat: 25.79,
    lng: -80.13,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 3.4,
    skusInStock: 90,
    flagshipLines: 'Whopper, Impossible, Chicken Fries, Onion Rings',
    trend: 'down' as const,
    description: 'Burger King Miami FL HQ flagship, 980 daily customers with 90 SKUs; flame-grilled Whopper pioneer facing share loss to fast-casual',
  },
  {
    id: 'bf-in-n-out',
    name: 'In-N-Out Baldwin Park CA',
    lat: 34.085,
    lng: -117.961,
    status: 'stable',
    value: 91,
    ...
    monthlyRevenue: 5.2,
    skusInStock: 12,
    flagshipLines: 'Hamburger, Cheeseburger, Double-Double, Fries, Shake',
    trend: 'up' as const,
    description: 'In-N-Out Baldwin Park CA original flagship, 1,450 daily customers with 12 SKUs; cult West Coast chain with secret menu and quality obsession',
  },
  {
    id: 'bf-shake-shack',
    name: 'Shake Shack NYC Madison Square',
    lat: 40.742,
    lng: -73.988,
    status: 'stable',
    value: 85,
    ...
    monthlyRevenue: 3.8,
    skusInStock: 30,
    flagshipLines: 'ShackBurger, SmokeShack, Crinkle Cut, Concrete',
    trend: 'up' as const,
    description: 'Shake Shack NYC Madison Square Park original, 820 daily customers with 30 SKUs; modern fast-casual burger pioneer since 2004',
  },
]
...
export function BurgerFryJointMonitor() {
  const state = useMapStore((s) => s.burgerFryJoint)
  const setState = useMapStore((s) => s.setBurgerFryJoint)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-red-700 to-rose-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Burger &amp; Fry Joint</h3>
        </div>
