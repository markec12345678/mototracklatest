...
const SAMPLE_LOCATIONS = [
  {
    id: 'sc-boulder',
    name: 'Boulder Salt Cave Cafe, Boulder CO',
    lat: 40.015,
    lng: -105.271,
    status: 'stable',
    value: 82,
    ...
    trend: 'up' as const,
    description: 'Boulder salt cave relaxation cafe serving halotherapy wellness clients',
  },
  {
    id: 'sc-asheville',
    name: 'Asheville Salt Cave Cafe, Asheville NC',
    lat: 35.595,
    lng: -82.551,
    status: 'stable',
    value: 76,
    ...
    monthlyRevenue: 0.4,
    skusInStock: 38,
    flagshipLines: 'Herbal Tea,Smoothies,Granola Bars,Snacks',
    trend: 'stable' as const,
    description: 'Asheville salt cave relaxation cafe serving Blue Ridge wellness clients',
  },
  {
    id: 'sc-sedona',
    name: 'Sedona Salt Cave Cafe, Sedona AZ',
    lat: 34.87,
    lng: -111.761,
    status: 'stable',
    value: 85,
    ...
    trend: 'up' as const,
    description: 'Sedona salt cave relaxation cafe serving red rock wellness retreatants',
  },
  {
    id: 'sc-saratoga',
    name: 'Saratoga Salt Cave Cafe, Saratoga Springs NY',
    lat: 43.083,
    lng: -73.785,
    status: 'moderate',
    value: 64,
    ...
    trend: 'down' as const,
    description: 'Saratoga Springs salt cave relaxation cafe serving Adirondack wellness clients',
  },
]
...
export function SaltCaveRelaxationCafeMonitor() {
  const state = useMapStore((s) => s.saltCaveRelaxationCafe)
  const setState = useMapStore((s) => s.setSaltCaveRelaxationCafe)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-rose-400 to-pink-700">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Salt Cave Relaxation Cafe</h3>
        </div>
