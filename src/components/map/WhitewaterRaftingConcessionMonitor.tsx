...
const SAMPLE_LOCATIONS = [
  {
    id: 'wr-ocoee',
    name: 'Ocoee River Rafting Concession, Benton TN',
    lat: 35.169,
    lng: -84.653,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 0.6,
    skusInStock: 68,
    flagshipLines: 'Sandwiches, Energy Bars, Soda, Water',
    trend: 'up' as const,
    description: 'Olympic whitewater venue concession serving rafters on the Ocoee River',
  },
  {
    id: 'wr-newriver',
    name: 'New River Gorge Rafting Concession, Fayetteville WV',
    lat: 38.052,
    lng: -81.083,
    status: 'stable',
    value: 79,
    ...
    monthlyRevenue: 0.8,
    skusInStock: 82,
    flagshipLines: 'BBQ Sandwiches, Cold Brew, Soda, Snacks',
    trend: 'up' as const,
    description: 'New River Gorge concession stand serving Class IV rapids rafters',
  },
  {
    id: 'wr-gauley',
    name: 'Gauley River Rafting Concession, Summersville WV',
    lat: 38.278,
    lng: -80.847,
    status: 'moderate',
    value: 68,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 75,
    flagshipLines: 'Hot Dogs, Chips, Soda, Water',
    trend: 'stable' as const,
    description: 'Gauley River fall release concession serving advanced rafters',
  },
  {
    id: 'wr-salmon',
    name: 'Salmon River Rafting Concession, Riggins ID',
    lat: 45.419,
    lng: -116.309,
    status: 'warning',
    value: 62,
    ...
    monthlyRevenue: 0.5,
    skusInStock: 60,
    flagshipLines: 'Sandwiches, Trail Mix, Soda, Water',
    trend: 'down' as const,
    description: 'Salmon River main fork concession serving multi-day trip rafters',
  },
]
...
export function WhitewaterRaftingConcessionMonitor() {
  const state = useMapStore((s) => s.whitewaterRaftingConcession)
  const setState = useMapStore((s) => s.setWhitewaterRaftingConcession)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-600 to-teal-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Whitewater Rafting Concession</h3>
        </div>
