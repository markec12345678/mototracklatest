...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 2.1,
    skusInStock: 5400,
    flagshipLines: 'Denim, Logo Hoodie, Active, Kids',
    trend: 'down' as const,
    description: 'Gap San Francisco CA HQ flagship, 410 daily customers with 5,400 SKUs; iconic American casual basics brand restructuring',
  },
  {
    id: 'ar-hm',
    name: 'H&M Herald Square NYC',
    lat: 40.752,
    lng: -73.987,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 3.4,
    skusInStock: 8800,
    flagshipLines: 'Divided, Basics, Conscious, Studio',
    trend: 'stable' as const,
    description: 'H&M Herald Square NYC flagship, 720 daily customers with 8,800 SKUs; fast-fashion leader with Conscious sustainable line',
  },
  {
    id: 'ar-zara',
    name: 'Zara SoHo NYC',
    ...
    monthlyRevenue: 4.8,
    skusInStock: 7200,
    flagshipLines: 'Woman, TRF, Men, Join Life',
    trend: 'up' as const,
    description: 'Zara SoHo NYC flagship, 680 daily customers with 7,200 SKUs; vertically integrated fast-fashion with weekly drops',
  },
  {
    id: 'ar-uniqlo',
    name: 'Uniqlo Fifth Avenue NYC',
    lat: 40.754,
    lng: -73.982,
    status: 'stable',
    value: 92,
    ...
    monthlyRevenue: 5.6,
    skusInStock: 9400,
    flagshipLines: 'HEATTECH, AIRism, Ultra Light Down, UT',
    trend: 'up' as const,
    description: 'Uniqlo Fifth Avenue NYC global flagship, 950 daily customers with 9,400 SKUs; Japanese tech-basic apparel innovator',
  },
]
...
export function ApparelRetailChainMonitor() {
  const state = useMapStore((s) => s.apparelRetailChain)
  const setState = useMapStore((s) => s.setApparelRetailChain)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-rose-600 to-pink-700">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Apparel Retail Chain</h3>
        </div>
