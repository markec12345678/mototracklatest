...
const SAMPLE_LOCATIONS = [
  {
    id: 'hb-lakepowell',
    name: 'Lake Powell Houseboat Cafe Page AZ',
    lat: 36.929,
    lng: -111.499,
    status: 'stable',
    value: 80,
    ...
    monthlyRevenue: 1.0,
    skusInStock: 95,
    flagshipLines: 'Sandwiches, Smoothies, Beer, Soda',
    trend: 'up' as const,
    description: 'Lake Powell Wahweap Marina houseboat rental cafe serving Glen Canyon boaters',
  },
  {
    id: 'hb-lakecumberland',
    name: 'Lake Cumberland Houseboat Cafe Jamestown KY',
    lat: 36.981,
    lng: -85.061,
    status: 'moderate',
    value: 65,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 78,
    flagshipLines: 'Burgers, Beer, Soda, Snacks',
    trend: 'stable' as const,
    description: 'Lake Cumberland State Dock houseboat rental cafe serving Kentucky houseboaters',
  },
  {
    id: 'hb-shasta',
    name: 'Shasta Lake Houseboat Cafe Redding CA',
    lat: 40.712,
    lng: -122.345,
    status: 'stable',
    value: 75,
    ...
    monthlyRevenue: 0.6,
    skusInStock: 72,
    flagshipLines: 'Tacos, Margaritas, Beer, Soda',
    trend: 'up' as const,
    description: 'Shasta Lake marina houseboat rental cafe serving Sacramento Valley boaters',
  },
  {
    id: 'hb-lakeoftheozarks',
    name: 'Lake of the Ozarks Houseboat Cafe Osage Beach MO',
    lat: 38.141,
    lng: -92.639,
    status: 'warning',
    value: 58,
    ...
    monthlyRevenue: 0.8,
    skusInStock: 85,
    flagshipLines: 'BBQ, Beer, Soda, Snacks',
    trend: 'down' as const,
    description: 'Lake of the Ozarks houseboat rental cafe serving Missouri summer vacationers',
  },
]
...
export function HouseboatRentalCafeMonitor() {
  const state = useMapStore((s) => s.houseboatRentalCafe)
  const setState = useMapStore((s) => s.setHouseboatRentalCafe)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-500 to-orange-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#127968;</span>
          <h3 className="text-sm font-semibold text-white">Houseboat Rental Cafe</h3>
        </div>
