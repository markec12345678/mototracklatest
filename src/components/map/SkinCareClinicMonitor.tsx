...
const SAMPLE_LOCATIONS = [
  {
    id: 'sc-losangeles',
    name: 'Skin Care Clinic Los Angeles',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 80,
    flagshipLines: 'Facials,Chemical Peels,Microdermabrasion,LED Therapy',
    trend: 'up' as const,
    description: 'Skin Care Clinic Los Angeles West Hollywood med-spa, 75 daily clients with 80 professional SKUs and signature facial protocols',
  },
  {
    id: 'sc-newyork',
    name: 'Skin Care Clinic New York',
    lat: 40.728,
    lng: -74.001,
    status: 'stable',
    value: 88,
    ...
    flagshipLines: 'Facials,Chemical Peels,Microdermabrasion,LED Therapy',
    trend: 'up' as const,
    description: 'Skin Care Clinic New York Midtown Manhattan med-spa, 90 daily clients with 92 professional SKUs serving fashion district professionals',
  },
  {
    id: 'sc-denver',
    name: 'Skin Care Clinic Denver',
    lat: 39.739,
    lng: -104.99,
    status: 'moderate',
    value: 70,
    ...
    description: 'Skin Care Clinic Denver Cherry Creek med-spa, 55 daily clients with 68 professional SKUs specializing in high-altitude hydration therapy',
  },
  {
    id: 'sc-sanfrancisco',
    name: 'Skin Care Clinic San Francisco',
    lat: 37.778,
    lng: -122.419,
    status: 'warning',
    value: 62,
    ...
    flagshipLines: 'Facials,Chemical Peels,Microdermabrasion,LED Therapy',
    trend: 'down' as const,
    description: 'Skin Care Clinic San Francisco Union Square med-spa, 65 daily clients with 72 professional SKUs navigating competitive Bay Area market',
  },
]
...
export function SkinCareClinicMonitor() {
  const state = useMapStore((s) => s.skinCareClinic)
  const setState = useMapStore((s) => s.setSkinCareClinic)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-rose-500 to-fuchsia-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#10024;</span>
          <h3 className="text-sm font-semibold text-white">Skin Care Clinic</h3>
        </div>
