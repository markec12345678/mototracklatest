...
const SAMPLE_LOCATIONS = [
  {
    id: 'hs-newyork',
    name: 'Hair Salon Studio New York',
    lat: 40.713,
    lng: -74.006,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 1.1,
    skusInStock: 85,
    flagshipLines: 'Cuts,Color,Highlights,Balayage',
    trend: 'up' as const,
    description: 'Hair Salon Studio New York flagship in SoHo, 110 daily customers with 85 service SKUs; full-service cut and color destination',
  },
  {
    id: 'hs-losangeles',
    name: 'Hair Salon Studio Los Angeles',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 1.2,
    skusInStock: 90,
    flagshipLines: 'Balayage,Keratin,Extensions,Color',
    trend: 'up' as const,
    description: 'Hair Salon Studio Los Angeles flagship in West Hollywood, 120 daily customers with 90 service SKUs; celebrity-styling anchor location',
  },
  {
    id: 'hs-chicago',
    name: 'Hair Salon Studio Chicago',
    lat: 41.878,
    lng: -87.63,
    status: 'moderate',
    value: 71,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 62,
    flagshipLines: 'Cuts,Color,Perm,Treatments',
    trend: 'stable' as const,
    description: 'Hair Salon Studio Chicago flagship in River North, 75 daily customers with 62 service SKUs; midwest regional hub',
  },
  {
    id: 'hs-miami',
    name: 'Hair Salon Studio Miami',
    lat: 25.762,
    lng: -80.192,
    status: 'warning',
    value: 58,
    ...
    monthlyRevenue: 0.4,
    skusInStock: 45,
    flagshipLines: 'Cuts,Highlights,Blowout,Treatments',
    trend: 'down' as const,
    description: 'Hair Salon Studio Miami flagship in Wynwood, 50 daily customers with 45 service SKUs; staffing shortages impacting throughput',
  },
]
...
export function HairSalonStudioMonitor() {
  const state = useMapStore((s) => s.hairSalonStudio)
  const setState = useMapStore((s) => s.setHairSalonStudio)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-pink-600 to-rose-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Hair Salon Studio</h3>
        </div>
