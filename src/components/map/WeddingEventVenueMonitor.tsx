...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 6.8,
    skusInStock: 210,
    flagshipLines: 'Biltmore Weddings, Vineyard Reception, Equestrian, Italian Garden',
    trend: 'up' as const,
    description: 'Biltmore Estate Asheville NC wedding and event venue, 380 daily guests with 210 event SKUs; America\'s largest private home with vineyard receptions',
  },
  {
    id: 'wev-bellagio',
    name: 'Bellagio Las Vegas NV',
    lat: 36.1129,
    lng: -115.1767,
    status: 'stable',
    value: 92,
    ...
    monthlyRevenue: 9.4,
    skusInStock: 280,
    flagshipLines: 'Bellagio Weddings, Terrazza, Tuscany Gardens, Chapel',
    trend: 'up' as const,
    description: 'Bellagio Las Vegas NV wedding and event venues, 520 daily guests with 280 SKUs; MGM Resorts flagship with ballroom and chapel packages',
  },
  {
    id: 'wev-waldorf',
    name: 'Waldorf Astoria New York NY',
    lat: 40.7566,
    lng: -73.9745,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 7.2,
    skusInStock: 240,
    flagshipLines: 'Waldorf Weddings, Grand Ballroom, Park Avenue, Lexington',
    trend: 'stable' as const,
    description: 'Waldorf Astoria New York NY event venue, 410 daily guests with 240 SKUs; Art Deco landmark with Park Avenue grand ballroom and suites',
  },
  {
    id: 'wev-fairmont',
    name: 'Fairmont San Francisco CA',
    lat: 37.7922,
    lng: -122.4110,
    status: 'moderate',
    value: 80,
    ...
    monthlyRevenue: 5.9,
    skusInStock: 195,
    flagshipLines: 'Fairmont Weddings, Crown Room, Laurel Court, Garden',
    trend: 'down' as const,
    description: 'Fairmont San Francisco CA Nob Hill event venue, 360 daily guests with 195 SKUs; historic 1907 hotel with bay-view ballrooms and rehearsal dinner packages',
  },
]
...
export function WeddingEventVenueMonitor() {
  const state = useMapStore((s) => s.weddingEventVenue)
  const setState = useMapStore((s) => s.setWeddingEventVenue)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-pink-700 to-rose-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Wedding &amp; Event Venue</h3>
        </div>
