...
const SAMPLE_LOCATIONS = [
  {
    id: 'sc-anapolis',
    name: 'Annapolis Yacht Club Bar, Annapolis MD',
    lat: 38.978,
    lng: -76.49,
    status: 'stable',
    value: 82,
    ...
    monthlyRevenue: 1.2,
    skusInStock: 110,
    flagshipLines: 'Crab Cakes, Chardonnay, Beer, Cocktails',
    trend: 'up' as const,
    description: 'Annapolis Yacht Club bar serving Chesapeake Bay sailors',
  },
  {
    id: 'sc-sanfrancisco',
    name: 'St Francis Yacht Club Bar, San Francisco CA',
    lat: 37.808,
    lng: -122.447,
    status: 'stable',
    value: 85,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 125,
    flagshipLines: 'Oysters, Champagne, Craft Beer, Cocktails',
    trend: 'stable' as const,
    description: 'St Francis Yacht Club bar serving San Francisco Bay racers',
  },
  {
    id: 'sc-newport',
    name: 'New York Yacht Club Bar, Newport RI',
    lat: 41.48,
    lng: -71.313,
    status: 'stable',
    value: 78,
    ...
    trend: 'up' as const,
    description: 'New York Yacht Club Harbor Court bar serving Narragansett Bay sailors',
  },
  {
    id: 'sc-seattle',
    name: 'Seattle Yacht Club Bar, Seattle WA',
    lat: 47.604,
    lng: -122.329,
    status: 'moderate',
    value: 62,
    ...
    monthlyRevenue: 0.9,
    skusInStock: 82,
    flagshipLines: 'Salmon Sandwiches, Microbrews, Wine, Cocktails',
    trend: 'down' as const,
    description: 'Seattle Yacht Club bar serving Puget Sound cruisers',
  },
]
...
export function SailingClubBarMonitor() {
  const state = useMapStore((s) => s.sailingClubBar)
  const setState = useMapStore((s) => s.setSailingClubBar)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-teal-600 to-emerald-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#9973;</span>
          <h3 className="text-sm font-semibold text-white">Sailing Club Bar</h3>
        </div>
