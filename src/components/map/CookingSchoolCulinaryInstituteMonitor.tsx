...
const SAMPLE_LOCATIONS = [
  {
    id: 'cs-cia',
    name: 'Culinary Institute of America Hyde Park NY',
    lat: 41.7897,
    lng: -73.9468,
    status: 'stable',
    value: 96,
    ...
    monthlyRevenue: 4.2,
    skusInStock: 8500,
    flagshipLines: 'Culinary Arts, Baking & Pastry, Wine Studies',
    trend: 'up' as const,
    description: 'Worlds premier culinary college founded 1946',
  },
  {
    id: 'cs-johnson-wales',
    name: 'Johnson & Wales University Providence RI',
    lat: 41.824,
    lng: -71.4128,
    status: 'stable',
    value: 90,
    ...
    monthlyRevenue: 3.1,
    skusInStock: 6200,
    flagshipLines: 'Culinary Arts, Food Service, Hospitality',
    trend: 'up' as const,
    description: 'Renowned culinary and hospitality university',
  },
  {
    id: 'cs-ice',
    name: 'Institute of Culinary Education NYC',
    lat: 40.7484,
    lng: -73.994,
    status: 'moderate',
    value: 82,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 3400,
    flagshipLines: 'Culinary Arts, Pastry & Baking, Restaurant Management',
    trend: 'flat' as const,
    description: 'NYCs largest culinary school with LA campus',
  },
  {
    id: 'cs-sf-cooking',
    name: 'San Francisco Cooking School SF CA',
    lat: 37.7749,
    lng: -122.4194,
    status: 'warning',
    value: 74,
    ...
    monthlyRevenue: 0.68,
    skusInStock: 1800,
    flagshipLines: 'Professional Culinary, Pastry, Plant-Based',
    trend: 'down' as const,
    description: 'Bay Area boutique culinary school with small cohorts',
  },
]
...
export function CookingSchoolCulinaryInstituteMonitor() {
  const state = useMapStore((s) => s.cookingSchoolCulinaryInstitute)
  const setState = useMapStore((s) => s.setCookingSchoolCulinaryInstitute)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-700 to-green-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Cooking School & Culinary Institute</h3>
        </div>
