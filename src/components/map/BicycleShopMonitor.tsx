...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 1.6,
    skusInStock: 2100,
    flagshipLines: 'Trek, Madone, Domane, Marlin, Fuel',
    trend: 'up' as const,
    description: 'Trek Bicycle Waterloo WI HQ flagship, 240 daily customers with 2,100 SKUs; US-made carbon frames and lifetime warranty leader',
  },
  {
    id: 'bs-specialized',
    name: 'Specialized Bicycle Morgan Hill CA',
    lat: 37.13,
    lng: -121.648,
    status: 'stable',
    value: 82,
    ...
    monthlyRevenue: 1.3,
    skusInStock: 1750,
    flagshipLines: 'Specialized, Tarmac, Roubaix, Stumpjumper, Allez',
    trend: 'stable' as const,
    description: 'Specialized Bicycle Morgan Hill CA flagship, 195 daily customers with 1,750 SKUs; premium road and mountain innovation hub',
  },
  {
    id: 'bs-giant',
    name: 'Giant Bicycles US Newbury Park CA',
    lat: 34.157,
    lng: -118.942,
    status: 'moderate',
    value: 71,
    ...
    monthlyRevenue: 0.95,
    skusInStock: 1480,
    flagshipLines: 'Giant, Liv, TCR, Defy, Trance',
    trend: 'stable' as const,
    description: 'Giant Bicycles US Newbury Park CA HQ, 165 daily customers with 1,480 SKUs; world largest frame manufacturer US distribution',
  },
  {
    id: 'bs-mikes-bikes',
    name: "Mike's Bikes Berkeley CA",
    lat: 37.872,
    lng: -122.297,
    status: 'warning',
    value: 58,
    ...
    monthlyRevenue: 0.62,
    skusInStock: 920,
    flagshipLines: 'Specialized, Trek, Santa Cruz, Salsa',
    trend: 'down' as const,
    description: "Mike's Bikes Berkeley CA flagship, 110 daily customers with 920 SKUs; Bay Area multi-store chain facing inventory and seasonal pressure",
  },
]
...
export function BicycleShopMonitor() {
  const state = useMapStore((s) => s.bicycleShop)
  const setState = useMapStore((s) => s.setBicycleShop)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-red-700 to-rose-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Bicycle Shop</h3>
        </div>
