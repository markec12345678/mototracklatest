...
const SAMPLE_LOCATIONS = [
  {
    id: 'sh-bestbuy-smart',
    name: 'Best Buy Smart Home Chicago IL',
    lat: 41.894,
    lng: -87.637,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 2400,
    flagshipLines: 'Ring, Nest, Philips Hue, Ecobee',
    trend: 'up' as const,
    description: 'Best Buy Smart Home display Chicago IL, 320 daily customers with 2,400 SKUs; dedicated smart-home In-Home Advisor zone',
  },
  {
    id: 'sh-vivint',
    name: 'Vivint Smart Home Pro Lehi UT',
    lat: 40.425,
    lng: -111.880,
    status: 'stable',
    value: 79,
    ...
    monthlyRevenue: 0.9,
    skusInStock: 620,
    flagshipLines: 'Vivint Hub, Outdoor Camera Pro, Element',
    trend: 'stable' as const,
    description: 'Vivint Smart Home Lehi UT flagship, 140 daily customers with 620 SKUs; full-service smart home security + automation',
  },
  {
    id: 'sh-abc-warehouse',
    name: 'ABC Warehouse Smart Home Livonia MI',
    lat: 42.368,
    lng: -83.358,
    status: 'moderate',
    value: 67,
    ...
    monthlyRevenue: 0.4,
    skusInStock: 980,
    flagshipLines: 'Sonos, Honeywell, Kwikset, TP-Link',
    trend: 'stable' as const,
    description: 'ABC Warehouse Livonia MI smart-home boutique, 75 daily customers with 980 SKUs; regional Michigan chain expanding smart-home',
  },
  {
    id: 'sh-connshome',
    name: "Conn's HomePlus Houston TX Smart",
    lat: 29.760,
    lng: -95.369,
    status: 'warning',
    value: 54,
    ...
    monthlyRevenue: 0.3,
    skusInStock: 720,
    flagshipLines: 'SimpliSafe, Ring, TP-Link Kasa',
    trend: 'down' as const,
    description: "Conn's HomePlus Houston TX smart section, 90 daily customers with 720 SKUs; mid-tier smart-home selection facing online pressure",
  },
]
...
export function SmartHomeTechStoreMonitor() {
  const state = useMapStore((s) => s.smartHomeTechStore)
  const setState = useMapStore((s) => s.setSmartHomeTechStore)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-700 to-teal-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Smart Home Tech Store</h3>
        </div>
