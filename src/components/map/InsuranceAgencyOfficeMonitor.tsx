...
const SAMPLE_LOCATIONS = [
  {
    id: 'in-hartford',
    name: 'The Hartford Hartford CT HQ',
    lat: 41.766,
    lng: -72.673,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 5.2,
    skusInStock: 78,
    flagshipLines: 'Auto, Home, Life, Business',
    trend: 'up' as const,
    description: 'The Hartford Hartford CT HQ flagship agency, 140 policyholders/day with 78 policy types; founding campus of the 200-year-old insurer',
  },
  {
    id: 'in-bloomington',
    name: 'State Farm Bloomington IL HQ',
    lat: 40.484,
    lng: -88.993,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 5.8,
    skusInStock: 90,
    flagshipLines: 'Auto, Home, Renters, Life, Health',
    trend: 'stable' as const,
    description: 'State Farm Bloomington IL HQ agency, 185 policyholders/day with 90 policy types; largest US auto/home insurer home office',
  },
  {
    id: 'in-northbrook',
    name: 'Allstate Northbrook IL HQ',
    lat: 42.128,
    lng: -87.833,
    status: 'moderate',
    value: 68,
    ...
    monthlyRevenue: 3.4,
    skusInStock: 62,
    flagshipLines: 'Auto, Home, Life, Annuities',
    trend: 'down' as const,
    description: 'Allstate Northbrook IL HQ agency, 95 policyholders/day with 62 policy types; parent relocating HQ to downtown Chicago',
  },
  {
    id: 'in-columbus',
    name: 'Nationwide Columbus OH HQ',
    lat: 39.961,
    lng: -82.999,
    status: 'warning',
    value: 54,
    ...
    monthlyRevenue: 2.6,
    skusInStock: 45,
    flagshipLines: 'Auto, Home, Commercial, Retirement',
    trend: 'down' as const,
    description: 'Nationwide Columbus OH HQ agency, 70 policyholders/day with 45 policy types; commercial lines retrenchment impacting foot traffic',
  },
]
...
export function InsuranceAgencyOfficeMonitor() {
  const state = useMapStore((s) => s.insuranceAgencyOffice)
  const setState = useMapStore((s) => s.setInsuranceAgencyOffice)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-teal-600 to-cyan-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Insurance Agency Office</h3>
        </div>
