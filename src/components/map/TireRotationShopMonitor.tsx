...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 1.6,
    skusInStock: 2300,
    flagshipLines: 'Tire Rotation, Alignment, Balancing, Tire Sales',
    trend: 'up' as const,
    description: 'Discount Tire Dallas TX flagship store, 110 vehicles serviced daily with 2,300 SKUs; Texas heat and highway driving drive steady rotation demand',
  },
  {
    id: 'tr-atlanta',
    name: 'Mavis Tire Atlanta GA',
    lat: 33.749,
    lng: -84.388,
    status: 'moderate',
    value: 70,
    ...
    description: 'Mavis Tire Atlanta GA service center, 88 vehicles serviced daily with 1,900 SKUs; Southeast corridor commuter tire specialist',
  },
  {
    id: 'tr-denver',
    name: 'Big O Tires Denver CO',
    lat: 39.739,
    lng: -104.990,
    status: 'warning',
    value: 58,
    ...
    flagshipLines: 'Tire Rotation, Alignment, Balancing, Tire Sales',
    trend: 'down' as const,
    description: 'Big O Tires Denver CO, 72 vehicles serviced daily with 1,500 SKUs; mountain winter swaps stress seasonal inventory and staffing',
  },
  {
    id: 'tr-seattle',
    name: 'Les Schwab Seattle WA',
    lat: 47.606,
    lng: -122.332,
    status: 'stable',
    value: 79,
    ...
    flagshipLines: 'Tire Rotation, Alignment, Balancing, Tire Sales',
    trend: 'up' as const,
    description: 'Les Schwab Seattle WA, 95 vehicles serviced daily with 2,050 SKUs; Pacific Northwest wet-season traction and rotation hub',
  },
]
...
export function TireRotationShopMonitor() {
  const state = useMapStore((s) => s.tireRotationShop)
  const setState = useMapStore((s) => s.setTireRotationShop)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-stone-600 to-slate-800">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#11044;</span>
          <h3 className="text-sm font-semibold text-white">Tire Rotation Shop</h3>
        </div>
