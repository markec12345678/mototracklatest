...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 8.4,
    skusInStock: 22000,
    flagshipLines: 'Canon EOS R5, Sony A1, Nikon Z9, Leica',
    trend: 'up' as const,
    description: 'B&H Photo NYC flagship, 1,640 daily customers with 22,000 SKUs; the largest photography retailer in North America',
  },
  {
    id: 'cp-adorama',
    name: 'Adorama NYC',
    ...
    monthlyRevenue: 3.2,
    skusInStock: 14500,
    flagshipLines: 'Fujifilm, Olympus, GoPro, DJI',
    trend: 'stable' as const,
    description: 'Adorama NYC Brooklyn flagship, 460 daily customers with 14,500 SKUs; B&H rival with strong used-gear program',
  },
  {
    id: 'cp-keh',
    name: 'KEH Camera Smyrna GA',
    lat: 33.874,
    lng: -84.515,
    status: 'moderate',
    value: 76,
    ...
    monthlyRevenue: 0.8,
    skusInStock: 9200,
    flagshipLines: 'Used Canon, Used Nikon, Used Sony',
    trend: 'up' as const,
    description: 'KEH Camera Smyrna GA HQ showroom, 95 daily customers with 9,200 used SKUs; largest used-gear reseller in the US',
  },
  {
    id: 'cp-samys',
    name: "Samy's Camera Los Angeles CA",
    lat: 34.046,
    lng: -118.348,
    status: 'stable',
    value: 81,
    ...
    monthlyRevenue: 1.3,
    skusInStock: 7800,
    flagshipLines: 'Canon, Sony, Leica, Phase One',
    trend: 'stable' as const,
    description: "Samy's Camera Los Angeles CA flagship, 220 daily customers with 7,800 SKUs; LA's largest indie photo retailer",
  },
]
...
export function CameraPhotoStoreMonitor() {
  const state = useMapStore((s) => s.cameraPhotoStore)
  const setState = useMapStore((s) => s.setCameraPhotoStore)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-cyan-700 to-blue-800">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#128247;</span>
          <h3 className="text-sm font-semibold text-white">Camera &amp; Photo Store</h3>
        </div>
