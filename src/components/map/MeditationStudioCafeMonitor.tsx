...
const SAMPLE_LOCATIONS = [
  {
    id: 'md-losangeles',
    name: 'Unplug Meditation Los Angeles Cafe',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 82,
    ...
    trend: 'up' as const,
    description: 'Unplug Meditation studio cafe serving West Hollywood mindfulness clients',
  },
  {
    id: 'md-newyork',
    name: 'MNDFL Meditation New York Cafe',
    lat: 40.728,
    lng: -74.001,
    status: 'stable',
    value: 85,
    ...
    description: 'MNDFL Meditation studio cafe serving Manhattan mindfulness clients',
  },
  {
    id: 'md-sanfrancisco',
    name: 'Sensorium Meditation San Francisco Cafe',
    lat: 37.778,
    lng: -122.419,
    status: 'moderate',
    value: 68,
    ...
    trend: 'up' as const,
    description: 'Sensorium Meditation studio cafe serving Mission District mindfulness clients',
  },
  {
    id: 'md-austin',
    name: 'Zen Meditation Austin Cafe',
    lat: 30.272,
    lng: -97.743,
    status: 'warning',
    value: 54,
    ...
    monthlyRevenue: 0.4,
    skusInStock: 38,
    flagshipLines: 'Herbal Tea,Smoothies,Energy Bars,Snacks',
    trend: 'down' as const,
    description: 'Zen Meditation studio cafe serving East Austin mindfulness clients',
  },
]
...
export function MeditationStudioCafeMonitor() {
  const state = useMapStore((s) => s.meditationStudioCafe)
  const setState = useMapStore((s) => s.setMeditationStudioCafe)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-violet-500 to-purple-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Meditation Studio Cafe</h3>
        </div>
