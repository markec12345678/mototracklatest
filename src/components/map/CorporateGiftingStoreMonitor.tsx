...
const SAMPLE_LOCATIONS = [
  {
    id: 'cg-harrydavid',
    name: 'Harry & David Medford OR HQ',
    lat: 42.327,
    lng: -122.876,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 2.4,
    skusInStock: 3400,
    flagshipLines: 'Fruit Baskets, Tower of Treats, Wolferman&apos;s',
    trend: 'up' as const,
    description: 'Harry & David Medford OR HQ flagship, 240 daily customers with 3,400 SKUs; since 1934, premier corporate gifting brand',
  },
  {
    id: 'cg-1800flowers',
    ...
    monthlyRevenue: 1.6,
    skusInStock: 2800,
    flagshipLines: 'Teleflora, Cheryl&apos;s, The Popcorn Factory',
    trend: 'stable' as const,
    description: '1-800-Flowers Carle Place NY HQ flagship, 180 daily customers with 2,800 SKUs; corporate gifting across flowers, treats, gift baskets',
  },
  {
    id: 'cg-sharis',
    name: "Shari's Berries HQ Sacramento CA",
    lat: 38.582,
    lng: -121.494,
    status: 'moderate',
    value: 71,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 1200,
    flagshipLines: 'Chocolate Dipped Strawberries, Gourmet Towers',
    trend: 'stable' as const,
    description: "Shari's Berries Sacramento CA HQ storefront, 95 daily customers with 1,200 SKUs; chocolate-dipped berry corporate gifts",
  },
  {
    id: 'cg-gourmetgiftbaskets',
    name: 'Gourmet Gift Baskets Plano TX',
    lat: 33.020,
    lng: -96.699,
    status: 'warning',
    value: 58,
    ...
    monthlyRevenue: 0.4,
    skusInStock: 850,
    flagshipLines: 'Snack Towers, Coffee Collections, Spa Gifts',
    trend: 'down' as const,
    description: 'Gourmet Gift Baskets Plano TX, 50 daily customers with 850 SKUs; mid-tier corporate gifting facing Amazon competition',
  },
]
...
export function CorporateGiftingStoreMonitor() {
  const state = useMapStore((s) => s.corporateGiftingStore)
  const setState = useMapStore((s) => s.setCorporateGiftingStore)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-violet-700 to-purple-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Corporate Gifting Store</h3>
        </div>
