...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 2.4,
    skusInStock: 80,
    flagshipLines: 'Cherry Garcia, Half Baked, Phish Food, Americone',
    trend: 'up' as const,
    description: 'Ben & Jerrys Waterbury VT factory tour scoop shop, 680 daily customers with 80 SKUs; Vermont heritage ice cream with social mission',
  },
  {
    id: 'ic-cold-stone',
    name: 'Cold Stone Creamery Scottsdale AZ HQ',
    lat: 33.494,
    lng: -111.926,
    status: 'stable',
    value: 81,
    ...
    monthlyRevenue: 1.6,
    skusInStock: 60,
    flagshipLines: 'Cold Stone, Birthday Cake, Oreo, Mint, Cake Batter',
    trend: 'stable' as const,
    description: 'Cold Stone Creamery Scottsdale AZ HQ flagship, 420 daily customers with 60 SKUs; mix-in ice cream chain with singing crew',
  },
  {
    id: 'ic-baskin',
    name: 'Baskin-Robbins Canton MA',
    lat: 42.158,
    lng: -71.183,
    status: 'moderate',
    value: 72,
    ...
    monthlyRevenue: 1.2,
    skusInStock: 31,
    flagshipLines: 'Baskin, Mint Choc Chip, Pralines, Jamoca, QTR',
    trend: 'down' as const,
    description: 'Baskin-Robbins Canton MA flagship, 340 daily customers with 31 SKUs; 31 flavors pioneer co-branded with Dunkin',
  },
  {
    id: 'ic-jeni',
    name: 'Jenis Splendid Columbus OH',
    lat: 39.962,
    lng: -82.998,
    status: 'stable',
    value: 78,
    ...
    monthlyRevenue: 1.0,
    skusInStock: 50,
    flagshipLines: 'Jenis, Brambleberry, Brown Butter, Salty Caramel',
    trend: 'up' as const,
    description: 'Jenis Splendid Columbus OH flagship, 290 daily customers with 50 SKUs; artisan direct-source ice cream with grocery expansion',
  },
]
...
export function IceCreamDessertShopMonitor() {
  const state = useMapStore((s) => s.iceCreamDessertShop)
  const setState = useMapStore((s) => s.setIceCreamDessertShop)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-cyan-700 to-sky-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Ice Cream &amp; Dessert Shop</h3>
        </div>
