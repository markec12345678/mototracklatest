...
const SAMPLE_LOCATIONS = [
  {
    id: 'pi-domino',
    name: 'Dominos Pizza Ann Arbor MI HQ',
    lat: 42.282,
    lng: -83.749,
    status: 'stable',
    value: 95,
    ...
    monthlyRevenue: 6.2,
    skusInStock: 60,
    flagshipLines: 'Dominos, Pepperoni, Ultimate, Hand Tossed, Brooklyn',
    trend: 'up' as const,
    description: 'Dominos Pizza Ann Arbor MI HQ flagship, 1,850 daily customers with 60 SKUs; global pizza delivery leader with tech-forward ordering',
  },
  {
    id: 'pi-pizza-hut',
    name: 'Pizza Hut Plano TX HQ',
    lat: 33.020,
    lng: -96.698,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 3.4,
    skusInStock: 80,
    flagshipLines: 'Pizza Hut, Original Pan, Stuffed Crust, Meat Lover',
    trend: 'down' as const,
    description: 'Pizza Hut Plano TX HQ flagship, 920 daily customers with 80 SKUs; original pizza chain facing delivery competition',
  },
  {
    id: 'pi-blaze',
    name: 'Blaze Pizza Pasadena CA',
    lat: 34.148,
    lng: -118.145,
    status: 'stable',
    value: 81,
    ...
    monthlyRevenue: 2.1,
    skusInStock: 40,
    flagshipLines: 'Blaze, Build-Your-Own, Fast-Fired, Dough',
    trend: 'up' as const,
    description: 'Blaze Pizza Pasadena CA flagship, 680 daily customers with 40 SKUs; fast-casual build-your-own pizza chain founded 2011',
  },
  {
    id: 'pi-joes',
    name: 'Joes Pizza New York NY',
    lat: 40.730,
    lng: -74.002,
    status: 'warning',
    value: 66,
    ...
    monthlyRevenue: 1.3,
    skusInStock: 25,
    flagshipLines: 'Joes, Plain Slice, Sicilian, Topping',
    trend: 'down' as const,
    description: 'Joes Pizza New York NY Greenwich Village, 410 daily customers with 25 SKUs; classic NY slice joint with tourism pressure on rents',
  },
]
...
export function PizzaItalianRestaurantMonitor() {
  const state = useMapStore((s) => s.pizzaItalianRestaurant)
  const setState = useMapStore((s) => s.setPizzaItalianRestaurant)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-red-700 to-rose-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Pizza & Italian Restaurant</h3>
        </div>
