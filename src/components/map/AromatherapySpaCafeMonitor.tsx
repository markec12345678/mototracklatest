...
const SAMPLE_LOCATIONS = [
  {
    id: 'ar-losangeles',
    name: 'Aroma Therapy Spa Los Angeles Cafe',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 78,
    ...
    monthlyRevenue: 0.6,
    skusInStock: 48,
    flagshipLines: 'Herbal Tea,Essential Oil Blends,Energy Bars,Snacks',
    trend: 'up' as const,
    description: 'Aroma Therapy Spa Los Angeles cafe serving West Hollywood essential oil therapy clients',
  },
  {
    id: 'ar-newyork',
    name: 'Aroma Therapy Spa New York Cafe',
    lat: 40.728,
    lng: -74.001,
    status: 'moderate',
    value: 82,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 55,
    flagshipLines: 'Espresso,Herbal Tea,Essential Oil Blends,Snacks',
    trend: 'stable' as const,
    description: 'Aroma Therapy Spa New York cafe serving Manhattan essential oil therapy clients',
  },
  {
    id: 'ar-sedona',
    name: 'Sedona Aromatherapy Spa Cafe',
    lat: 34.87,
    lng: -111.761,
    status: 'stable',
    value: 75,
    ...
    flagshipLines: 'Herbal Tea,Essential Oil Blends,Energy Bars,Snacks',
    trend: 'up' as const,
    description: 'Sedona Aromatherapy Spa cafe serving red rock vortex essential oil therapy clients',
  },
  {
    id: 'ar-asheville',
    name: 'Asheville Aromatherapy Spa Cafe',
    lat: 35.595,
    lng: -82.551,
    status: 'warning',
    value: 68,
    ...
    monthlyRevenue: 0.5,
    skusInStock: 45,
    flagshipLines: 'Coffee,Herbal Tea,Essential Oil Blends,Snacks',
    trend: 'down' as const,
    description: 'Asheville Aromatherapy Spa cafe serving Blue Ridge essential oil therapy clients',
  },
]
...
export function AromatherapySpaCafeMonitor() {
  const state = useMapStore((s) => s.aromatherapySpaCafe)
  const setState = useMapStore((s) => s.setAromatherapySpaCafe)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-rose-400 to-pink-700">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#127800;</span>
          <h3 className="text-sm font-semibold text-white">Aromatherapy Spa Cafe</h3>
        </div>
