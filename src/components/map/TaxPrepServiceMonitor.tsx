...
const SAMPLE_LOCATIONS = [
  {
    id: 'tp-kansascity',
    name: 'H&R Block Kansas City MO HQ',
    lat: 39.100,
    lng: -94.579,
    status: 'stable',
    value: 85,
    ...
    monthlyRevenue: 3.6,
    skusInStock: 54,
    flagshipLines: 'Individual Returns,Business Returns,Audit Support,Refund Loans',
    trend: 'up' as const,
    description: 'H&R Block Kansas City MO global HQ, 132 daily clients with 54 service offerings; largest US tax prep chain serving 20M+ filers yearly',
  },
  {
    id: 'tp-newyork',
    name: 'Jackson Hewitt New York NY',
    lat: 40.754,
    lng: -73.994,
    status: 'stable',
    value: 76,
    ...
    description: 'Jackson Hewitt New York NY flagship, 96 daily clients with 41 service offerings; second-largest US tax prep franchise network',
  },
  {
    id: 'tp-dallas',
    name: 'Liberty Tax Dallas TX',
    lat: 32.777,
    lng: -96.797,
    status: 'moderate',
    value: 68,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 32,
    flagshipLines: 'Individual Returns,Business Returns,Audit Support,Refund Advance',
    trend: 'down' as const,
    description: 'Liberty Tax Dallas TX regional hub, 64 daily clients with 32 service offerings; seasonal franchise model facing staffing headwinds',
  },
  {
    id: 'tp-phoenix',
    name: 'Desert Ridge CPA Phoenix AZ',
    lat: 33.448,
    lng: -112.074,
    status: 'warning',
    value: 59,
    ...
    monthlyRevenue: 0.9,
    skusInStock: 22,
    flagshipLines: 'Individual Returns,Business Returns,Bookkeeping,Estate Planning',
    trend: 'down' as const,
    description: 'Desert Ridge CPA Phoenix AZ independent firm, 38 daily clients with 22 service offerings; boutique practice squeezed by DIY software adoption',
  },
]
...
export function TaxPrepServiceMonitor() {
  const state = useMapStore((s) => s.taxPrepService)
  const setState = useMapStore((s) => s.setTaxPrepService)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-600 to-orange-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Tax Prep Service</h3>
        </div>
