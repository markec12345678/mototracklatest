...
const SAMPLE_LOCATIONS = [
  {
    id: 'st-sanfrancisco',
    name: 'Spray Tan Studio San Francisco',
    lat: 37.778,
    lng: -122.419,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 140,
    flagshipLines: 'Airbrush Tan,Express Tan,Glow Drops,Pre-Tan Prep',
    trend: 'up' as const,
    description: 'Spray Tan Studio San Francisco in Marina District serving bridal and event clientele with custom airbrush tanning',
  },
  {
    id: 'st-miami',
    name: 'Spray Tan Studio Miami',
    lat: 25.762,
    lng: -80.191,
    status: 'stable',
    value: 83,
    ...
    flagshipLines: 'Airbrush Tan,Express Tan,Glow Drops,Pre-Tan Prep',
    trend: 'up' as const,
    description: 'Spray Tan Studio Miami in South Beach serving year-round beach, swim, and event clientele with high-volume airbrush tanning',
  },
  {
    id: 'st-phoenix',
    name: 'Spray Tan Studio Phoenix',
    lat: 33.448,
    lng: -112.074,
    status: 'moderate',
    value: 69,
    ...
    description: 'Spray Tan Studio Phoenix in Scottsdale serving pool-party and snowbird clientele with express and airbrush tanning',
  },
  {
    id: 'st-dallas',
    name: 'Spray Tan Studio Dallas',
    lat: 32.780,
    lng: -96.801,
    status: 'warning',
    value: 57,
    ...
    flagshipLines: 'Airbrush Tan,Express Tan,Glow Drops,Pre-Tan Prep',
    trend: 'down' as const,
    description: 'Spray Tan Studio Dallas in Uptown serving pageant and event clientele with declining bookings against new competitors',
  },
]
...
export function SprayTanStudioMonitor() {
  const state = useMapStore((s) => s.sprayTanStudio)
  const setState = useMapStore((s) => s.setSprayTanStudio)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-500 to-orange-800">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#9728;</span>
          <h3 className="text-sm font-semibold text-white">Spray Tan Studio</h3>
        </div>
