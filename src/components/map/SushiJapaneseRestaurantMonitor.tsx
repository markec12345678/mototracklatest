...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 4.8,
    skusInStock: 80,
    flagshipLines: 'Black Cod Miso, Yellowtail Jalapeno, Omakase, Tiradito',
    trend: 'up' as const,
    description: 'Nobu Malibu CA beachfront flagship, 320 daily customers with 80 SKUs; celebrity sushi destination by Nobuyuki Matsuhisa and Robert De Niro',
  },
  {
    id: 'sj-masa',
    name: 'Masa NYC Columbus Circle',
    lat: 40.768,
    lng: -73.982,
    status: 'stable',
    value: 96,
    ...
    monthlyRevenue: 2.4,
    skusInStock: 60,
    flagshipLines: 'Omakase, Toro, Uni, Caviar, Truffle',
    trend: 'stable' as const,
    description: 'Masa NYC Columbus Circle, 45 daily customers with 60 SKUs; 3-Michelin-star omakase counter by Masa Takayama, $950 prix fixe',
  },
  {
    id: 'sj-kura',
    name: 'Kura Sushi Atlanta GA',
    lat: 33.749,
    lng: -84.388,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 1.9,
    skusInStock: 120,
    flagshipLines: 'Conveyor Belt, Nigiri, Rolls, Gacha Reward',
    trend: 'up' as const,
    description: 'Kura Sushi Atlanta GA flagship, 580 daily customers with 120 SKUs; revolving sushi bar chain with tablet ordering and prize system',
  },
  {
    id: 'sj-sugarfish',
    name: 'Sugarfish Beverly Hills CA',
    lat: 34.067,
    lng: -118.401,
    status: 'warning',
    value: 71,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 40,
    flagshipLines: 'Nozawa Trust Me, Traditional, Blue Crab Hand Roll',
    trend: 'down' as const,
    description: 'Sugarfish Beverly Hills CA flagship, 290 daily customers with 40 SKUs; Nozawa-style trust-me sushi chain facing post-pandemic recovery',
  },
]
...
export function SushiJapaneseRestaurantMonitor() {
  const state = useMapStore((s) => s.sushiJapaneseRestaurant)
  const setState = useMapStore((s) => s.setSushiJapaneseRestaurant)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-cyan-700 to-sky-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Sushi &amp; Japanese Restaurant</h3>
        </div>
