...
const SAMPLE_LOCATIONS = [
  {
    id: 'fb-feeding-america',
    name: 'Feeding America Chicago IL HQ',
    lat: 41.8781,
    lng: -87.6298,
    status: 'stable',
    value: 96,
    dailyCustomers: 46000,
    monthlyRevenue: 12.4,
    skusInStock: 12000,
    flagshipLines: 'Food Rescue, Distribution, SNAP Outreach',
    trend: 'up' as const,
    description: 'Nations largest hunger-relief organization with 200 food banks',
  },
  {
    id: 'fb-greater-chicago',
    name: 'Greater Chicago Food Deposary Chicago IL',
    lat: 41.7344,
    lng: -87.6477,
    status: 'stable',
    value: 92,
    ...
    monthlyRevenue: 4.8,
    skusInStock: 6800,
    flagshipLines: 'Pantry Network, Produce, Senior Boxes',
    trend: 'up' as const,
    description: 'Chicagos food bank serving 700+ partner agencies',
  },
  {
    id: 'fb-nyc-food',
    name: 'Food Bank For New York City Bronx NY',
    lat: 40.7282,
    lng: -73.7949,
    status: 'moderate',
    value: 84,
    ...
    monthlyRevenue: 3.6,
    skusInStock: 5200,
    flagshipLines: 'Pantry Distribution, Soup Kitchens, SNAP',
    trend: 'flat' as const,
    description: 'NYCs major hunger-relief organization serving 1.5M New Yorkers',
  },
  {
    id: 'fb-sf-marin',
    name: 'SF-Marin Food Bank San Francisco CA',
    lat: 37.762,
    lng: -122.4019,
    status: 'warning',
    value: 78,
    ...
    monthlyRevenue: 2.4,
    skusInStock: 3800,
    flagshipLines: 'Pantry Network, Home-Delivered Groceries, CalFresh',
    trend: 'down' as const,
    description: 'Bay Area food bank serving 60000+ households weekly',
  },
]
...
export function FoodBankPantryMonitor() {
  const state = useMapStore((s) => s.foodBankPantry)
  const setState = useMapStore((s) => s.setFoodBankPantry)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-orange-700 to-amber-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Food Bank & Pantry</h3>
        </div>
