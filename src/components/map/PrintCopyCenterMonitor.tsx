...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 1.4,
    skusInStock: 1800,
    flagshipLines: 'Print, Signs, Banners, Shipping',
    trend: 'up' as const,
    description: 'FedEx Office 5th Avenue Manhattan NYC flagship, 380 daily customers; high-volume print + shipping hub',
  },
  {
    id: 'pc-ups-store',
    name: 'The UPS Store San Diego CA HQ',
    lat: 32.832,
    lng: -117.150,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 1.0,
    skusInStock: 1200,
    flagshipLines: 'Print, Shipping, Mailbox, Notary',
    trend: 'stable' as const,
    description: 'The UPS Store San Diego CA HQ flagship, 240 daily customers; print, copy, shipping and mailbox services',
  },
  {
    id: 'pc-staples-print',
    name: 'Staples Print & Marketing Framingham MA',
    lat: 42.299,
    lng: -71.414,
    status: 'moderate',
    value: 70,
    ...
    monthlyRevenue: 0.5,
    skusInStock: 900,
    flagshipLines: 'Print, Marketing Materials, Business Cards',
    trend: 'down' as const,
    description: 'Staples Print & Marketing Framingham MA, 110 daily customers; declining walk-in print volume as digital adoption grows',
  },
  {
    id: 'pc-alphagraphics',
    name: 'AlphaGraphics Chicago IL',
    lat: 41.884,
    lng: -87.632,
    status: 'stable',
    value: 76,
    ...
    monthlyRevenue: 0.6,
    skusInStock: 1500,
    flagshipLines: 'Print, Signs, Direct Mail, Design',
    trend: 'stable' as const,
    description: 'AlphaGraphics Chicago IL Loop flagship, 85 daily customers; B2B-focused print + direct mail marketing services',
  },
]
...
export function PrintCopyCenterMonitor() {
  const state = useMapStore((s) => s.printCopyCenter)
  const setState = useMapStore((s) => s.setPrintCopyCenter)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-700 to-orange-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Print &amp; Copy Center</h3>
        </div>
