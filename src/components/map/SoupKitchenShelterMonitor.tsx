...
const SAMPLE_LOCATIONS = [
  {
    id: 'sk-holy-apostles',
    name: 'Holy Apostles Soup Kitchen NYC Chelsea',
    lat: 40.7484,
    lng: -74.006,
    status: 'stable',
    value: 92,
    ...
    monthlyRevenue: 0.42,
    skusInStock: 480,
    flagshipLines: 'Hot Meals, Pantry Bags, Social Services',
    trend: 'up' as const,
    description: 'NYCs largest soup kitchen serving 1000+ meals daily since 1982',
  },
  {
    id: 'sk-st-anthony',
    name: 'St. Anthony Foundation San Francisco Tenderloin',
    lat: 37.7833,
    lng: -122.4131,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 0.78,
    skusInStock: 620,
    flagshipLines: 'Dining Room, Free Clothing, Medical Clinic',
    trend: 'up' as const,
    description: 'SF Tenderloin dining room serving 3000+ meals daily',
  },
  {
    id: 'sk-chicago-food',
    name: 'A Just Harvest Chicago Rogers Park',
    lat: 42.0086,
    lng: -87.6703,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 0.18,
    skusInStock: 280,
    flagshipLines: 'Community Kitchen, Food Pantry, SNAP Outreach',
    trend: 'flat' as const,
    description: 'Chicago community kitchen serving 365 days a year',
  },
  {
    id: 'sk-boston-rescue',
    name: 'Boston Rescue Mission Boston MA',
    lat: 42.336,
    lng: -71.063,
    status: 'warning',
    value: 72,
    ...
    monthlyRevenue: 0.22,
    skusInStock: 320,
    flagshipLines: 'Meals, Shelter, Recovery Programs',
    trend: 'down' as const,
    description: 'Bostons oldest shelter and soup kitchen since 1899',
  },
]
...
export function SoupKitchenShelterMonitor() {
  const state = useMapStore((s) => s.soupKitchenShelter)
  const setState = useMapStore((s) => s.setSoupKitchenShelter)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-stone-700 to-amber-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Soup Kitchen &amp; Shelter</h3>
        </div>
