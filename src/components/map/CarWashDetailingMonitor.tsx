...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 1.12,
    skusInStock: 210,
    flagshipLines: 'Exterior Wash,Interior Detail,Waxing,Ceramic Coating',
    trend: 'up' as const,
    description: 'Mister Car Wash Miami FL full-service tunnel, 145 vehicles daily with 210 SKUs; humidity-fueled demand drives premium ceramic-coating packages',
  },
  {
    id: 'cw-losangeles',
    name: 'Quick Quack Car Wash Los Angeles CA',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 80,
    ...
    description: 'Quick Quack Car Wash Los Angeles CA express tunnel, 130 vehicles daily with 195 SKUs; unlimited-membership model anchors recurring revenue',
  },
  {
    id: 'cw-houston',
    name: 'Supercar Wash Houston TX',
    lat: 29.76,
    lng: -95.369,
    status: 'moderate',
    value: 66,
    ...
    flagshipLines: 'Exterior Wash,Interior Detail,Waxing,Ceramic Coating',
    trend: 'down' as const,
    description: 'Supercar Wash Houston TX detailing center, 90 vehicles daily with 150 SKUs; staffing gaps have reduced interior-detail throughput',
  },
  {
    id: 'cw-sanfrancisco',
    name: 'Detail Garage San Francisco CA',
    lat: 37.774,
    lng: -122.419,
    status: 'warning',
    value: 52,
    ...
    flagshipLines: 'Exterior Wash,Interior Detail,Waxing,Ceramic Coating',
    trend: 'down' as const,
    description: 'Detail Garage San Francisco CA boutique detailing bay, 65 vehicles daily with 110 SKUs; drought restrictions cap exterior-wash volume',
  },
]
...
export function CarWashDetailingMonitor() {
  const state = useMapStore((s) => s.carWashDetailing)
  const setState = useMapStore((s) => s.setCarWashDetailing)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-cyan-600 to-teal-800">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#128703;</span>
          <h3 className="text-sm font-semibold text-white">Car Wash Detailing</h3>
        </div>
