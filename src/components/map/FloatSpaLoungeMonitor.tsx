...
const SAMPLE_LOCATIONS = [
  {
    id: 'fs-losangeles',
    name: 'Float Lab Los Angeles Venice CA',
    lat: 33.985,
    lng: -118.469,
    status: 'stable',
    value: 78,
    ...
    trend: 'up' as const,
    description: 'Venice Beach float spa lounge serving sensory deprivation tank clients',
  },
  {
    id: 'fs-austin',
    name: 'Zen Float Co Austin TX',
    lat: 30.272,
    lng: -97.743,
    status: 'moderate',
    value: 65,
    ...
    monthlyRevenue: 0.4,
    skusInStock: 40,
    flagshipLines: 'Kombucha, Herbal Tea, Granola Bars, Snacks',
    trend: 'stable' as const,
    description: 'Austin float spa lounge serving sensory deprivation wellness clients',
  },
  {
    id: 'fs-portland',
    name: 'Float On Portland OR',
    lat: 45.505,
    lng: -122.685,
    status: 'moderate',
    value: 70,
    ...
    trend: 'up' as const,
    description: 'Hawthorne District float spa lounge serving Pacific Northwest wellness clients',
  },
  {
    id: 'fs-newyork',
    name: 'Lift Float New York NY',
    lat: 40.728,
    lng: -74.001,
    status: 'stable',
    value: 82,
    ...
    trend: 'up' as const,
    description: 'Manhattan float spa lounge serving sensory deprivation therapy clients',
  },
]
...
export function FloatSpaLoungeMonitor() {
  const state = useMapStore((s) => s.floatSpaLounge)
  const setState = useMapStore((s) => s.setFloatSpaLounge)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-violet-500 to-purple-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Float Spa Lounge</h3>
        </div>
