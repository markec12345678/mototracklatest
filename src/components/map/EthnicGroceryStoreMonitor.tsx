...
const SAMPLE_LOCATIONS = [
  {
    id: 'eg-99-ranch',
    name: '99 Ranch Market Irvine CA',
    lat: 33.6839,
    lng: -117.8256,
    status: 'stable',
    value: 92,
    ...
    monthlyRevenue: 1.8,
    skusInStock: 8500,
    flagshipLines: 'Live Seafood, Asian Produce, Sake & Tea',
    trend: 'up' as const,
    description: 'Largest Asian-American supermarket chain with regional produce',
  },
  {
    id: 'eg-patel-brothers',
    name: 'Patel Brothers Jackson Heights NY',
    lat: 40.7547,
    lng: -73.8726,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 1.1,
    skusInStock: 4200,
    flagshipLines: 'Basmati Rice, Spices, Fresh Curry Leaves',
    trend: 'up' as const,
    description: 'Iconic Indian grocery serving diaspora across the US',
  },
  {
    id: 'eg-mexico-city',
    name: 'Mexico City Foods Los Angeles CA',
    lat: 34.0469,
    lng: -118.2892,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 0.72,
    skusInStock: 2800,
    flagshipLines: 'Masa, Tortillas, Dried Chiles',
    trend: 'flat' as const,
    description: 'Latin American grocer with fresh tortilleria',
  },
  {
    id: 'eg-toko',
    name: 'Toko Asian Market Houston TX',
    lat: 29.738,
    lng: -95.532,
    status: 'warning',
    value: 70,
    ...
    monthlyRevenue: 0.45,
    skusInStock: 3200,
    flagshipLines: 'Filipino Pantry, Frozen Lumpia, Tropical Fruit',
    trend: 'down' as const,
    description: 'Southeast Asian market with Filipino specialties',
  },
]
...
export function EthnicGroceryStoreMonitor() {
  const state = useMapStore((s) => s.ethnicGroceryStore)
  const setState = useMapStore((s) => s.setEthnicGroceryStore)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-violet-600 to-purple-700">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Ethnic Grocery Store</h3>
        </div>
