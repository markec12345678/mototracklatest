...
const SAMPLE_LOCATIONS = [
  {
    id: 'fm-union-square',
    name: 'Union Square Greenmarket NYC',
    lat: 40.7359,
    lng: -73.9911,
    status: 'stable',
    value: 92,
    ...
    monthlyRevenue: 0.85,
    skusInStock: 580,
    flagshipLines: 'Hudson Valley Apples, Heirloom Tomatoes, Artisan Bread',
    trend: 'up' as const,
    description: 'Iconic NYC greenmarket with 140+ regional farmers',
  },
  {
    id: 'fm-santa-monica',
    name: 'Santa Monica Farmers Market CA',
    lat: 34.0175,
    lng: -118.4912,
    status: 'stable',
    value: 90,
    ...
    monthlyRevenue: 0.74,
    skusInStock: 720,
    flagshipLines: 'California Avocados, Citrus, Specialty Greens',
    trend: 'up' as const,
    description: "Chef-favorite market supplying LA's top restaurants",
  },
  {
    id: 'fm-pike-place',
    name: 'Pike Place Market Farmers Seattle WA',
    lat: 47.6097,
    lng: -122.3422,
    status: 'moderate',
    value: 82,
    ...
    monthlyRevenue: 1.1,
    skusInStock: 980,
    flagshipLines: 'Washington Cherries, Salmon, Tulips',
    trend: 'flat' as const,
    description: 'Historic public market with farm-fresh Pacific NW produce',
  },
  {
    id: 'fm-ferry-plaza',
    name: 'Ferry Plaza Farmers Market San Francisco CA',
    lat: 37.7955,
    lng: -122.3937,
    status: 'warning',
    value: 76,
    ...
    monthlyRevenue: 0.52,
    skusInStock: 460,
    flagshipLines: 'Mission Figs, Artisan Cheese, Olive Oil',
    trend: 'down' as const,
    description: 'Saturday market at Embarcadero with California growers',
  },
]
...
export function FarmersMarketStandMonitor() {
  const state = useMapStore((s) => s.farmersMarketStand)
  const setState = useMapStore((s) => s.setFarmersMarketStand)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-orange-600 to-amber-700">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Farmers Market Stand</h3>
        </div>
