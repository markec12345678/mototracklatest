...
const SAMPLE_LOCATIONS = [
  {
    id: 'hy-bikram',
    name: 'Bikram Yoga Los Angeles Studio Cafe',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 0.9,
    skusInStock: 72,
    flagshipLines: 'Coconut Water,Green Smoothies,Energy Bars,Snacks',
    trend: 'up' as const,
    description: 'Bikram Yoga Los Angeles studio cafe serving West Hollywood hot yoga practitioners',
  },
  {
    id: 'hy-corepower',
    name: 'CorePower Yoga New York Studio Cafe',
    lat: 40.728,
    lng: -74.001,
    status: 'stable',
    value: 79,
    ...
    description: 'CorePower Yoga Manhattan studio cafe serving C2 hot yoga practitioners',
  },
  {
    id: 'hy-modern',
    name: 'Modern Yoga Chicago Studio Cafe',
    lat: 41.878,
    lng: -87.63,
    status: 'moderate',
    value: 68,
    ...
    trend: 'up' as const,
    description: 'Modern Yoga Chicago studio cafe serving Loop district hot yoga practitioners',
  },
  {
    id: 'hy-yogagreenhouse',
    name: 'Yoga Greenhouse Austin Studio Cafe',
    lat: 30.272,
    lng: -97.743,
    status: 'warning',
    value: 58,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 60,
    flagshipLines: 'Kombucha,Green Smoothies,Energy Bars,Snacks',
    trend: 'down' as const,
    description: 'Yoga Greenhouse Austin studio cafe serving East Austin hot yoga practitioners',
  },
]
...
export function HotYogaStudioCafeMonitor() {
  const state = useMapStore((s) => s.hotYogaStudioCafe)
  const setState = useMapStore((s) => s.setHotYogaStudioCafe)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-orange-500 to-rose-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Hot Yoga Studio Cafe</h3>
        </div>
