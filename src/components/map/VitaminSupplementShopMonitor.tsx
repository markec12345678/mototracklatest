...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 2.8,
    skusInStock: 3200,
    flagshipLines: ['Whey Protein', 'Multivitamins', 'Pre-Workout'],
    trend: 'up' as const,
    description: 'Global supplement retailer with branded stores nationwide',
  },
  {
    id: 'vs-vitamin-shoppe',
    name: 'The Vitamin Shoppe Secaucus NJ HQ',
    lat: 40.7895,
    lng: -74.0561,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 1.9,
    skusInStock: 4500,
    flagshipLines: ['BodyTech', 'Plnt', 'True Athlete'],
    trend: 'up' as const,
    description: 'Specialty supplement retailer with private-label brands',
  },
  {
    id: 'vs-vitamin-world',
    name: 'Vitamin World Hicksville NY',
    lat: 40.7684,
    lng: -73.5224,
    status: 'moderate',
    value: 74,
    ...
    monthlyRevenue: 0.78,
    skusInStock: 2100,
    flagshipLines: ['Vitamin C', 'Omega-3 Fish Oil', 'Collagen'],
    trend: 'flat' as const,
    description: 'Mall-based supplement chain with lab-tested formulas',
  },
  {
    id: 'vs-puritan',
    name: 'Puritan\'s Pride Bohemia NY',
    lat: 40.7754,
    lng: -73.1151,
    status: 'warning',
    value: 68,
    ...
    monthlyRevenue: 0.52,
    skusInStock: 1800,
    flagshipLines: ['Vitamin D3', 'B-Complex', 'Herbal Extracts'],
    trend: 'down' as const,
    description: 'Direct-to-consumer vitamin manufacturer with outlet store',
  },
]
...
export function VitaminSupplementShopMonitor() {
  const state = useMapStore((s) => s.vitaminSupplementShop)
  const setState = useMapStore((s) => s.setVitaminSupplementShop)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-600 to-orange-700">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Vitamin &amp; Supplement Shop</h3>
        </div>
