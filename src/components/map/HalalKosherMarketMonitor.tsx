...
const SAMPLE_LOCATIONS = [
  {
    id: 'hk-alsafa',
    name: 'Al-Safa Halal Meat Chicago IL',
    lat: 41.8781,
    lng: -87.6298,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 0.92,
    skusInStock: 2400,
    flagshipLines: 'Halal Beef, Lamb, Middle Eastern Spices',
    trend: 'up' as const,
    description: 'Halal butcher and grocery serving Chicago\'s Muslim community',
  },
  {
    id: 'hk-kosher-market',
    name: 'The Kosher Marketplace NYC Upper West Side',
    lat: 40.7831,
    lng: -73.9712,
    status: 'stable',
    value: 90,
    ...
    monthlyRevenue: 1.1,
    skusInStock: 3800,
    flagshipLines: 'Glatt Kosher Beef, Kosher Wine, Cholent Cuts',
    trend: 'up' as const,
    description: 'Full-service kosher market with certified supervision',
  },
  {
    id: 'hk-crescent',
    name: 'Crescent Foods Darien IL',
    lat: 41.753,
    lng: -87.732,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 0.68,
    skusInStock: 1900,
    flagshipLines: 'Halal Chicken, Grass-Fed Beef, Organic Lamb',
    trend: 'flat' as const,
    description: 'Premium halal poultry and meat distributor',
  },
  {
    id: 'hk-pomegranate',
    name: 'Pomegranate Brooklyn NY',
    lat: 40.6288,
    lng: -73.9844,
    status: 'warning',
    value: 72,
    ...
    monthlyRevenue: 0.55,
    skusInStock: 2600,
    flagshipLines: 'Kosher Deli, Glatt Kosher, Israeli Products',
    trend: 'down' as const,
    description: 'Upscale kosher supermarket in Brooklyn',
  },
]
...
export function HalalKosherMarketMonitor() {
  const state = useMapStore((s) => s.halalKosherMarket)
  const setState = useMapStore((s) => s.setHalalKosherMarket)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-stone-600 to-emerald-700">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#9878;</span>
          <h3 className="text-sm font-semibold text-white">Halal & Kosher Market</h3>
        </div>
