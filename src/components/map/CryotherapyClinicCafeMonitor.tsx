...
const SAMPLE_LOCATIONS = [
  {
    id: 'cr-losangeles',
    name: 'Restore Cryotherapy Los Angeles Cafe',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 84,
    ...
    trend: 'up' as const,
    description: 'Restore Hyper Wellness Los Angeles cryotherapy clinic cafe serving recovery clients',
  },
  {
    id: 'cr-newyork',
    name: 'Restore Cryotherapy New York Cafe',
    lat: 40.728,
    lng: -74.001,
    status: 'stable',
    value: 80,
    ...
    description: 'Restore Hyper Wellness Manhattan cryotherapy clinic cafe serving recovery clients',
  },
  {
    id: 'cr-chicago',
    name: 'CryoChicago Clinic Cafe',
    lat: 41.878,
    lng: -87.63,
    status: 'moderate',
    value: 72,
    ...
    trend: 'up' as const,
    description: 'CryoChicago clinic cafe serving Loop district recovery clients',
  },
  {
    id: 'cr-dallas',
    name: 'CryoZone Dallas Clinic Cafe',
    lat: 32.778,
    lng: -96.799,
    status: 'warning',
    value: 58,
    ...
    trend: 'down' as const,
    description: 'CryoZone Dallas clinic cafe serving Uptown recovery clients',
  },
]
...
export function CryotherapyClinicCafeMonitor() {
  const state = useMapStore((s) => s.cryotherapyClinicCafe)
  const setState = useMapStore((s) => s.setCryotherapyClinicCafe)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-cyan-500 to-sky-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#10052;</span>
          <h3 className="text-sm font-semibold text-white">Cryotherapy Clinic Cafe</h3>
        </div>
