...
const SAMPLE_LOCATIONS = [
  {
    id: 'ac-losangeles',
    name: 'Acupuncture Clinic Los Angeles Cafe',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 85,
    ...
    monthlyRevenue: 0.6,
    skusInStock: 52,
    flagshipLines: 'Herbal Tea,Green Smoothies,Energy Bars,Snacks',
    trend: 'up' as const,
    description: 'Acupuncture Clinic Los Angeles cafe serving West Hollywood traditional Chinese medicine clients',
  },
  {
    id: 'ac-newyork',
    name: 'Acupuncture Clinic New York Cafe',
    lat: 40.728,
    lng: -74.001,
    status: 'moderate',
    value: 76,
    ...
    description: 'Acupuncture Clinic New York cafe serving Manhattan traditional Chinese medicine clients',
  },
  {
    id: 'ac-sanfrancisco',
    name: 'Acupuncture Clinic San Francisco Cafe',
    lat: 37.778,
    lng: -122.419,
    status: 'stable',
    value: 82,
    ...
    trend: 'up' as const,
    description: 'Acupuncture Clinic San Francisco cafe serving Chinatown traditional Chinese medicine clients',
  },
  {
    id: 'ac-seattle',
    name: 'Acupuncture Clinic Seattle Cafe',
    lat: 47.606,
    lng: -122.332,
    status: 'warning',
    value: 60,
    ...
    flagshipLines: 'Coffee,Herbal Tea,Energy Bars,Snacks',
    trend: 'down' as const,
    description: 'Acupuncture Clinic Seattle cafe serving Capitol Hill traditional Chinese medicine clients',
  },
]
...
export function AcupunctureClinicCafeMonitor() {
  const state = useMapStore((s) => s.acupunctureClinicCafe)
  const setState = useMapStore((s) => s.setAcupunctureClinicCafe)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-teal-500 to-emerald-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#9889;</span>
          <h3 className="text-sm font-semibold text-white">Acupuncture Clinic Cafe</h3>
        </div>
