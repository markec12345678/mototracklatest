...
const SAMPLE_LOCATIONS = [
  {
    id: 'bc-fleishers',
    name: 'Fleishers Craft Butcher Brooklyn NY',
    lat: 40.678,
    lng: -73.978,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 0.92,
    skusInStock: 220,
    flagshipLines: 'Grass-Fed Ribeye, Pasture Pork, House Bacon, Dry-Aged',
    trend: 'up' as const,
    description: 'Fleishers Craft Butcher Brooklyn NY flagship, 180 daily customers with 220 SKUs; whole-animal craft butcher with pasture-raised sourcing',
  },
  {
    id: 'bc-belcampo',
    name: 'Belcampo Meat Co San Francisco CA',
    lat: 37.76,
    lng: -122.435,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 0.78,
    skusInStock: 180,
    flagshipLines: 'Belcampo Burger, Filet, Bacon, Bone Broth',
    trend: 'stable' as const,
    description: 'Belcampo Meat Co San Francisco CA flagship, 145 daily customers with 180 SKUs; vertically-integrated sustainable butcher with own ranch',
  },
  {
    id: 'bc-the-meat-hook',
    name: 'The Meat Hook Brooklyn NY',
    lat: 40.718,
    lng: -73.955,
    status: 'stable',
    value: 81,
    ...
    monthlyRevenue: 0.62,
    skusInStock: 240,
    flagshipLines: 'House Sausage, Pate, Bacon, Whole Hog',
    trend: 'up' as const,
    description: 'The Meat Hook Brooklyn NY Williamsburg, 130 daily customers with 240 SKUs; artisan whole-animal butcher with house-made charcuterie program',
  },
  {
    id: 'bc-lobels',
    name: 'Lobels of New York NYC',
    lat: 40.778,
    lng: -73.982,
    status: 'warning',
    value: 72,
    ...
    monthlyRevenue: 0.58,
    skusInStock: 140,
    flagshipLines: 'USDA Prime Ribeye, Strip, Filet, Roast',
    trend: 'down' as const,
    description: 'Lobels of New York NYC Upper East Side, 95 daily customers with 140 SKUs; 5-generation family butcher since 1840 with premium dry-aging',
  },
]
...
export function ButcherCharcuterieShopMonitor() {
  const state = useMapStore((s) => s.butcherCharcuterieShop)
  const setState = useMapStore((s) => s.setButcherCharcuterieShop)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-rose-700 to-red-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Butcher &amp; Charcuterie Shop</h3>
        </div>
