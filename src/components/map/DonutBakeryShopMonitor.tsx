...
const SAMPLE_LOCATIONS = [
  {
    id: 'db-krispy-kreme',
    name: 'Krispy Kreme Winston-Salem NC HQ',
    lat: 36.073,
    lng: -80.166,
    status: 'stable',
    value: 87,
    ...
    monthlyRevenue: 2.6,
    skusInStock: 90,
    flagshipLines: 'Original Glazed, Chocolate Iced, Filled, Cake',
    trend: 'up' as const,
    description: 'Krispy Kreme Winston-Salem NC HQ flagship, 720 daily customers with 90 SKUs; Hot Light doughnut innovator with global expansion',
  },
  {
    id: 'db-dunkin',
    name: 'Dunkin Canton MA HQ',
    lat: 42.158,
    lng: -71.183,
    status: 'stable',
    value: 91,
    ...
    monthlyRevenue: 4.8,
    skusInStock: 220,
    flagshipLines: 'Dunkin, Glazed, Boston, Munchkin, Coffee',
    trend: 'stable' as const,
    description: 'Dunkin Canton MA HQ flagship store, 1,450 daily customers with 220 SKUs; coffee and donut chain leader rebranded from Dunkin Donuts',
  },
  {
    id: 'db-pastrys',
    name: 'Prairie Bakery Chicago IL',
    lat: 41.878,
    lng: -87.630,
    status: 'moderate',
    value: 68,
    ...
    monthlyRevenue: 0.92,
    skusInStock: 140,
    flagshipLines: 'Croissant, Brioche, Donut, Babka, Baguette',
    trend: 'stable' as const,
    description: 'Prairie Bakery Chicago IL flagship, 280 daily customers with 140 SKUs; artisan bakery and donut shop with morning commuter traffic',
  },
  {
    id: 'db-voodoo',
    name: 'Voodoo Doughnut Portland OR',
    lat: 45.522,
    lng: -122.676,
    status: 'warning',
    value: 64,
    ...
    monthlyRevenue: 1.1,
    skusInStock: 80,
    flagshipLines: 'Voodoo Doll, Bacon Maple, Memphis Mafia',
    trend: 'down' as const,
    description: 'Voodoo Doughnut Portland OR flagship, 410 daily customers with 80 SKUs; cult pink-box donut shop with tourism-driven foot traffic',
  },
]
...
export function DonutBakeryShopMonitor() {
  const state = useMapStore((s) => s.donutBakeryShop)
  const setState = useMapStore((s) => s.setDonutBakeryShop)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-pink-700 to-rose-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Donut &amp; Bakery Shop</h3>
        </div>
