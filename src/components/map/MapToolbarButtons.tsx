    ...
    <>
      ...
      <div className="absolute top-2 right-2 left-2 sm:top-3 sm:right-3 sm:left-3 z-10 flex items-start gap-1.5 sm:gap-2 transition-all duration-300 md:pl-0">
        ...
        <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
          ...
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setVolcanicLahar({ open: true })} title="Volcanic Lahar" aria-label="Open volcanic lahar monitor"><MountainIcon9 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setSaltFlat({ open: true })} title="Salt Flat" aria-label="Open salt flat monitor"><SunIcon8 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setDeepSeaCoral({ open: true })} title="Deep-Sea Coral" aria-label="Open deep-sea coral monitor"><FishIcon4 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setRipCurrent({ open: true })} title="Rip Current" aria-label="Open rip current monitor"><AlertTriangleIcon className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setMeteorImpact({ open: true })} title="Meteor Impact" aria-label="Open meteor impact tracker"><ZapIcon3 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setTidalBore({ open: true })} title="Tidal Bore" aria-label="Open tidal bore monitor"><DropletsIcon8 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setPeatlandCarbon({ open: true })} title="Peatland Carbon" aria-label="Open peatland carbon monitor"><LeafIcon6 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setGlacierSurge({ open: true })} title="Glacier Surge" aria-label="Open glacier surge monitor"><MountainIcon10 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setSargassumBloom({ open: true })} title="Sargassum Bloom" aria-label="Open sargassum bloom monitor"><WavesIcon11 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setIceLensFormation({ open: true })} title="Ice Lens Formation" aria-label="Open ice lens formation monitor"><SnowflakeIcon6 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setCoastalDeadZone({ open: true })} title="Coastal Dead Zone" aria-label="Open coastal dead zone monitor"><AlertTriangleIcon2 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setVolcanicTremor({ open: true })} title="Volcanic Tremor" aria-label="Open volcanic tremor monitor"><ActivityIcon4 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setSandDuneMigration({ open: true })} title="Sand Dune Migration" aria-label="Open sand dune migration monitor"><WindIcon8 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setOceanMixing({ open: true })} title="Ocean Mixing" aria-label="Open ocean mixing monitor"><DropletsIcon9 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setFrostHeave({ open: true })} title="Frost Heave" aria-label="Open frost heave monitor"><ThermometerIcon7 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setMarineHeatwave({ open: true })} title="Marine Heatwave" aria-label="Open marine heatwave monitor"><FlameIcon11 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setKelpForestDecline({ open: true })} title="Kelp Forest Decline" aria-label="Open kelp forest decline monitor"><TreePineIcon6 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setAtmosphericRiver({ open: true })} title="Atmospheric River" aria-label="Open atmospheric river monitor"><CloudRainIcon4 className="h-4 w-4" /></Button>
          ...
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setVolcanicGasPlume({ open: true })} title="Volcanic Gas Plume" aria-label="Open volcanic gas plume monitor"><FlameIcon12 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setCoastalWetland({ open: true })} title="Coastal Wetland" aria-label="Open coastal wetland monitor"><WavesIcon12 className="h-4 w-4" /></Button>
          ...
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setCoralSpawnSync({ open: true })} title="Coral Spawn Sync" aria-label="Open coral spawn sync monitor"><SparklesIcon6 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setLavaTube({ open: true })} title="Lava Tube" aria-label="Open lava tube monitor"><FlameIcon13 className="h-4 w-4" /></Button>
          ...
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setIceStreamVelocity({ open: true })} title="Ice Stream Velocity" aria-label="Open ice stream velocity monitor"><SnowflakeIcon8 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setSubmarinePipeline({ open: true })} title="Submarine Pipeline" aria-label="Open submarine pipeline monitor"><AnchorIcon3 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setMonsoonTrack({ open: true })} title="Monsoon Track" aria-label="Open monsoon track monitor"><CloudRainIcon5 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setRockGlacier({ open: true })} title="Rock Glacier" aria-label="Open rock glacier monitor"><MountainIcon11 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setCoastalAcid({ open: true })} title="Coastal Acid" aria-label="Open coastal acid monitor"><DropletsIcon11 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setAbyssalVent({ open: true })} title="Abyssal Vent" aria-label="Open abyssal vent monitor"><FlameIcon14 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setDesertLocust({ open: true })} title="Desert Locust" aria-label="Open desert locust monitor"><BugIcon4 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setGlacierLake({ open: true })} title="Glacier Lake" aria-label="Open glacier lake monitor"><DropletsIcon12 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setTidalPower({ open: true })} title="Tidal Power" aria-label="Open tidal power monitor"><ZapIcon5 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setPeatFireRisk({ open: true })} title="Peat Fire Risk" aria-label="Open peat fire risk monitor"><ThermometerIcon9 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setStratosphericWind({ open: true })} title="Stratospheric Wind" aria-label="Open stratospheric wind monitor"><WindIcon10 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setPolarOzone({ open: true })} title="Polar Ozone" aria-label="Open polar ozone monitor"><SunIcon10 className="h-4 w-4" /></Button>
          <Button variant="outline" size="icon" className="map-control-glass h-9 w-9 sm:h-10 sm:w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95" onClick={() => useMapStore.getState().setVolcanicLightning({ open: true })} title="Volcanic Lightning" aria-label="Open volcanic lightning monitor"><BoltIcon2 className="h-4 w-4" /></Button>
          <Button
            variant="outline"
            size="icon"
            className="hidden sm:flex map-control-glass h-10 w-10 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95"
