...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 7.4,
    skusInStock: 12500,
    flagshipLines: 'Apple, Samsung, Sony, LG, HP',
    trend: 'up' as const,
    description: 'Best Buy Richfield MN HQ flagship superstore, 920 daily customers with 12,500 SKUs spanning Apple, Samsung, Sony and LG home theater',
  },
  {
    id: 'ec-bestbuy-herald',
    name: "Best Buy 5th Ave NYC",
    lat: 40.754,
    lng: -73.978,
    status: 'stable',
    value: 89,
    ...
    monthlyRevenue: 9.2,
    skusInStock: 9800,
    flagshipLines: 'Apple, Microsoft, Bose, Dyson',
    trend: 'up' as const,
    description: 'Best Buy 5th Avenue Manhattan NYC flagship, 1,450 daily customers with 9,800 SKUs and high-traffic Manhattan demo',
  },
  {
    id: 'ec-walmart-electronics',
    name: 'Walmart Electronics Bentonville AR',
    lat: 36.373,
    lng: -94.209,
    status: 'stable',
    value: 82,
    ...
    monthlyRevenue: 6.8,
    skusInStock: 7400,
    flagshipLines: 'Vizio, Onn, RCA, TCL',
    trend: 'stable' as const,
    description: 'Walmart Electronics Bentonville AR supercenter, 2,100 daily customers with 7,400 SKUs; value-tier consumer electronics',
  },
  {
    id: 'ec-target-electronics',
    name: 'Target Electronics Minneapolis MN',
    lat: 44.983,
    lng: -93.273,
    status: 'moderate',
    value: 71,
    ...
    monthlyRevenue: 3.1,
    skusInStock: 4200,
    flagshipLines: 'Apple, Heyday,Sony, Vizio',
    trend: 'down' as const,
    description: 'Target Electronics Minneapolis MN flagship, 880 daily customers with 4,200 SKUs; mid-tier selection facing online pressure',
  },
]
...
export function ElectronicsRetailChainMonitor() {
  const state = useMapStore((s) => s.electronicsRetailChain)
  const setState = useMapStore((s) => s.setElectronicsRetailChain)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-blue-700 to-indigo-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Electronics Retail Chain</h3>
        </div>
