...
const SAMPLE_LOCATIONS = [
  {
    id: 'mtc-amc',
    name: 'AMC Empire 25 New York NY',
    lat: 40.7566,
    lng: -73.9881,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 4.8,
    skusInStock: 380,
    flagshipLines: 'AMC, Coke, Pepsi, Dine-In, MacGuffins',
    trend: 'up' as const,
    description: 'AMC Empire 25 Times Square NYC 25-screen flagship, 9,200 daily patrons with 380 SKUs; AMC Theatres largest US chain with Dine-In and MacGuffins bar concepts',
  },
  {
    id: 'mtc-regal',
    name: 'Regal LA Live Los Angeles CA',
    lat: 34.0456,
    lng: -118.268,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 4.1,
    skusInStock: 350,
    flagshipLines: 'Regal, 4DX, RPX, Coke, Cinnabon',
    trend: 'up' as const,
    description: 'Regal LA Live Los Angeles CA 14-screen downtown flagship, 7,800 daily patrons with 350 SKUs; Cineworld subsidiary with RPX premium large format',
  },
  {
    id: 'mtc-cinemark',
    name: 'Cinemark Plano TX HQ',
    lat: 33.0198,
    lng: -96.6989,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 3.6,
    skusInStock: 320,
    flagshipLines: 'Cinemark, XD, Coffee, All You Can Eat, Coke',
    trend: 'stable' as const,
    description: 'Cinemark Plano TX HQ flagship theater, 6,500 daily patrons with 320 SKUs; third-largest US circuit with XD premium format and luxury loungers',
  },
  {
    id: 'mtc-alamo',
    name: 'Alamo Drafthouse Brooklyn NY',
    lat: 40.6907,
    lng: -73.9908,
    status: 'moderate',
    value: 76,
    ...
    monthlyRevenue: 2.4,
    skusInStock: 410,
    flagshipLines: 'Alamo, Drafthouse Kitchen, Local Brew, Cinebowl, Vader',
    trend: 'up' as const,
    description: 'Alamo Drafthouse Brooklyn NY 7-screen dine-in cinema, 3,200 daily patrons with 410 SKUs; in-seat full restaurant service and strict no-talking policy',
  },
]
...
export function MovieTheaterConcessionMonitor() {
  const state = useMapStore((s) => s.movieTheaterConcession)
  const setState = useMapStore((s) => s.setMovieTheaterConcession)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-red-700 to-rose-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Movie Theater Concession</h3>
        </div>
