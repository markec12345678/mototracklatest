...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 3.4,
    skusInStock: 2200,
    flagshipLines: 'Aeron, Sayl, Embody, Eames Lounge',
    trend: 'up' as const,
    description: 'Herman Miller Zeeland MI flagship showroom, 140 daily customers with 2,200 SKUs; iconic Aeron chair + Eames collection',
  },
  {
    id: 'bf-steelcase',
    name: 'Steelcase Grand Rapids MI',
    lat: 42.963,
    lng: -85.668,
    status: 'stable',
    value: 89,
    ...
    monthlyRevenue: 2.8,
    skusInStock: 1900,
    flagshipLines: 'Leap, Gesture, Series 2, Answer',
    trend: 'stable' as const,
    description: 'Steelcase Grand Rapids MI WorkLife Center, 120 daily customers with 1,900 SKUs; largest office furniture manufacturer globally',
  },
  {
    id: 'bf-knoll',
    name: 'Knoll East Greenville PA',
    lat: 40.389,
    lng: -75.326,
    status: 'moderate',
    value: 74,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 1200,
    flagshipLines: 'Life, Generation, ReGeneration, Saarinen',
    trend: 'stable' as const,
    description: 'Knoll East Greenville PA showroom, 65 daily customers with 1,200 SKUs; acquired by MillerKnoll in 2021',
  },
  {
    id: 'bf-ikea',
    ...
    monthlyRevenue: 4.2,
    skusInStock: 9500,
    flagshipLines: 'MARKUS, JÄRVFJÄLLET, BEKANT, ALEFJÄLL',
    trend: 'up' as const,
    description: 'IKEA Brooklyn NY flagship, 2,200 daily customers with 9,500 SKUs; value office furniture + home workstation leader',
  },
]
...
export function BusinessFurnitureStoreMonitor() {
  const state = useMapStore((s) => s.businessFurnitureStore)
  const setState = useMapStore((s) => s.setBusinessFurnitureStore)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-800 to-yellow-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Business Furniture Store</h3>
        </div>
