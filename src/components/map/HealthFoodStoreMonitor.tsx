...
const SAMPLE_LOCATIONS = [
  {
    id: 'hf-whole-foods',
    name: 'Whole Foods Market Austin TX HQ',
    lat: 30.251,
    lng: -97.7493,
    status: 'stable',
    value: 96,
    ...
    monthlyRevenue: 4.2,
    skusInStock: 8500,
    flagshipLines: ['365 Organic', 'Plant-Based', 'Local Produce'],
    trend: 'up' as const,
    description: 'Premium organic grocer with strict quality standards',
  },
  {
    id: 'hf-sprouts',
    name: 'Sprouts Farmers Market Phoenix AZ HQ',
    lat: 33.4484,
    lng: -112.074,
    status: 'stable',
    value: 90,
    ...
    monthlyRevenue: 3.1,
    skusInStock: 6200,
    flagshipLines: ['Fresh Produce', 'Bulk Foods', 'Vitamins'],
    trend: 'up' as const,
    description: 'Healthy-focused grocery chain with farm-fresh produce',
  },
  {
    id: 'hf-natural-grocers',
    name: 'Natural Grocers Lakewood CO HQ',
    lat: 39.7047,
    lng: -105.0814,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 1.1,
    skusInStock: 4200,
    flagshipLines: ['Organic Produce', 'Dietary Supplements', 'Grass-Fed Dairy'],
    trend: 'flat' as const,
    description: 'Family-owned organic grocer with nutritionist staff',
  },
  {
    id: 'hf-thrifty',
    name: 'Thrifty Foods Boulder CO',
    lat: 40.015,
    lng: -105.2705,
    status: 'warning',
    value: 64,
    ...
    monthlyRevenue: 0.42,
    skusInStock: 1800,
    flagshipLines: ['Local Honey', 'Fermented Foods', 'Herbal Remedies'],
    trend: 'down' as const,
    description: 'Small health food co-op emphasizing local and fermented foods',
  },
]
...
export function HealthFoodStoreMonitor() {
  const state = useMapStore((s) => s.healthFoodStore)
  const setState = useMapStore((s) => s.setHealthFoodStore)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-600 to-green-700">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Health Food Store</h3>
        </div>
