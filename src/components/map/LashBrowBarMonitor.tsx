...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 0.9,
    skusInStock: 65,
    flagshipLines: 'Lash Extensions,Brow Lamination,Tinting,Microblading',
    trend: 'up' as const,
    description: 'Lash Brow Bar Miami flagship studio in South Beach, 75 daily clients with full lash extension and brow lamination menu',
  },
  {
    id: 'lb-losangeles',
    name: 'Lash Brow Bar Los Angeles',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 85,
    ...
    flagshipLines: 'Lash Extensions,Brow Lamination,Tinting,Microblading',
    trend: 'up' as const,
    description: 'Lash Brow Bar Los Angeles studio in West Hollywood, 90 daily clients specializing in volume lash extensions',
  },
  {
    id: 'lb-newyork',
    name: 'Lash Brow Bar New York',
    lat: 40.713,
    lng: -74.006,
    status: 'moderate',
    value: 72,
    ...
    description: 'Lash Brow Bar New York studio in SoHo, 80 daily clients offering microblading and brow tinting services',
  },
  {
    id: 'lb-chicago',
    name: 'Lash Brow Bar Chicago',
    lat: 41.878,
    lng: -87.63,
    status: 'warning',
    value: 58,
    ...
    flagshipLines: 'Lash Extensions,Brow Lamination,Tinting,Microblading',
    trend: 'down' as const,
    description: 'Lash Brow Bar Chicago studio in Lincoln Park, 45 daily clients facing staffing challenges for brow artists',
  },
]
...
export function LashBrowBarMonitor() {
  const state = useMapStore((s) => s.lashBrowBar)
  const setState = useMapStore((s) => s.setLashBrowBar)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-violet-600 to-purple-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#128065;</span>
          <h3 className="text-sm font-semibold text-white">Lash Brow Bar</h3>
        </div>
