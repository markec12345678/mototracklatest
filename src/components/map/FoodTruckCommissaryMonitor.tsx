...
const SAMPLE_LOCATIONS = [
  {
    id: 'ft-portland-commissary',
    name: 'Portland Food Truck Commissary Portland OR',
    lat: 45.5152,
    lng: -122.6784,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 0.42,
    skusInStock: 48,
    flagshipLines: 'Truck Parking, Commissary Kitchen, Power, Water',
    trend: 'up' as const,
    description: 'Premier Pacific NW commissary serving 40+ food trucks',
  },
  {
    id: 'ft-austin-food-park',
    name: 'Austin Food Park Austin TX',
    lat: 30.2672,
    lng: -97.7431,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 0.48,
    skusInStock: 56,
    flagshipLines: 'Truck Pods, Restrooms, Storage, Events',
    trend: 'up' as const,
    description: "Austin's largest food truck park with full commissary",
  },
  {
    id: 'ft-la-commissary',
    name: 'LA Commissary Kitchen Los Angeles CA',
    lat: 34.0522,
    lng: -118.2437,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 0.36,
    skusInStock: 42,
    flagshipLines: 'Health-Code Kitchen, Cold Storage, Prep Stations',
    trend: 'flat' as const,
    description: 'LA County certified shared commissary for food trucks',
  },
  {
    id: 'ft-seattle-mobile',
    name: 'Seattle Mobile Food Commissary Seattle WA',
    lat: 47.6062,
    lng: -122.3321,
    status: 'warning',
    value: 70,
    ...
    monthlyRevenue: 0.28,
    skusInStock: 36,
    flagshipLines: 'Truck Servicing, Commissary, Greywater Dump',
    trend: 'down' as const,
    description: 'King County permitted commissary serving Seattle trucks',
  },
]
...
export function FoodTruckCommissaryMonitor() {
  const state = useMapStore((s) => s.foodTruckCommissary)
  const setState = useMapStore((s) => s.setFoodTruckCommissary)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-orange-700 to-red-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Food Truck Commissary</h3>
        </div>
