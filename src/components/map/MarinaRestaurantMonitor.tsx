...
const SAMPLE_LOCATIONS = [
  {
    id: 'mr-marinaldelrey',
    name: 'Marina del Rey Restaurant, Marina del Rey CA',
    lat: 33.978,
    lng: -118.451,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 1.8,
    skusInStock: 145,
    flagshipLines: 'Seafood Pasta, Swordfish, Wine, Cocktails',
    trend: 'up' as const,
    description: 'Marina del Rey waterfront restaurant serving the largest man-made small craft harbor',
  },
  {
    id: 'mr-montauk',
    name: 'Montauk Marina Restaurant, Montauk NY',
    lat: 41.048,
    lng: -71.953,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 1.6,
    skusInStock: 130,
    flagshipLines: 'Lobster Rolls, Tuna, Wine, Beer',
    trend: 'up' as const,
    description: 'Montauk Marina restaurant serving the easternmost Long Island fishing fleet',
  },
  {
    id: 'mr-keywest',
    name: 'Key West Marina Restaurant, Key West FL',
    lat: 24.555,
    lng: -81.808,
    status: 'stable',
    value: 80,
    ...
    monthlyRevenue: 1.5,
    skusInStock: 122,
    flagshipLines: 'Conch Fritters, Key Lime Pie, Margaritas, Beer',
    trend: 'stable' as const,
    description: 'Key West Historic Seaport marina restaurant serving charter boat guests',
  },
  {
    id: 'mr-boothbay',
    name: 'Boothbay Harbor Marina Restaurant, Boothbay Harbor ME',
    lat: 43.852,
    lng: -69.627,
    status: 'warning',
    value: 58,
    ...
    monthlyRevenue: 0.9,
    skusInStock: 78,
    flagshipLines: 'Lobster Rolls, Clam Chowder, Beer, Wine',
    trend: 'down' as const,
    description: 'Boothbay Harbor marina restaurant serving Maine midcoast boaters',
  },
]
...
export function MarinaRestaurantMonitor() {
  const state = useMapStore((s) => s.marinaRestaurant)
  const setState = useMapStore((s) => s.setMarinaRestaurant)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-cyan-600 to-teal-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Marina Restaurant</h3>
        </div>
