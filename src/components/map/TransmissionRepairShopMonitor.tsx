...
const SAMPLE_LOCATIONS = [
  {
    id: 'tx-austin',
    name: 'AAMCO Transmission Austin TX',
    lat: 30.267,
    lng: -97.743,
    status: 'stable',
    value: 82,
    ...
    monthlyRevenue: 0.78,
    skusInStock: 380,
    flagshipLines: 'Transmission Rebuild,Clutch Repair,Fluid Service,Diagnostics',
    trend: 'up' as const,
    description: 'AAMCO Transmission Austin TX flagship center, 36 daily customers with 380 SKUs; full rebuild bays and clutch replacement specialists on staff',
  },
  {
    id: 'tx-nashville',
    name: 'Lee Myles Transmission Nashville TN',
    lat: 36.162,
    lng: -86.781,
    status: 'moderate',
    value: 67,
    ...
    description: 'Lee Myles Transmission Nashville TN service center, 29 daily customers with 240 SKUs; diagnostics-first workflow and CVT fluid specialists',
  },
  {
    id: 'tx-portland',
    name: 'Cottman Transmission Portland OR',
    lat: 45.515,
    lng: -122.679,
    status: 'warning',
    value: 52,
    ...
    flagshipLines: 'Transmission Rebuild,Clutch Repair,Fluid Service,Diagnostics',
    trend: 'down' as const,
    description: 'Cottman Transmission Portland OR shop, 22 daily customers with 170 SKUs; tech shortage extending rebuild turnaround to 9 business days',
  },
  {
    id: 'tx-raleigh',
    name: 'Mister Transmission Raleigh NC',
    lat: 35.779,
    lng: -78.638,
    status: 'stable',
    value: 80,
    ...
    flagshipLines: 'Transmission Rebuild,Clutch Repair,Fluid Service,Diagnostics',
    trend: 'up' as const,
    description: 'Mister Transmission Raleigh NC repair hub, 33 daily customers with 310 SKUs; heavy-duty truck transmission rebuilds and fleet contract specialist',
  },
]
...
export function TransmissionRepairShopMonitor() {
  const state = useMapStore((s) => s.transmissionRepairShop)
  const setState = useMapStore((s) => s.setTransmissionRepairShop)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-violet-700 to-purple-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Transmission Repair Shop</h3>
        </div>
