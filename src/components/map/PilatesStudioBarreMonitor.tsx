...
const SAMPLE_LOCATIONS = [
  {
    id: 'pl-losangeles',
    name: 'Hot Pilates Los Angeles Studio Barre',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 82,
    ...
    trend: 'up' as const,
    description: 'Hot Pilates studio barre serving West Hollywood fitness clients',
  },
  {
    id: 'pl-newyork',
    name: 'SLT Pilates New York Studio Barre',
    lat: 40.728,
    lng: -74.001,
    status: 'stable',
    value: 78,
    ...
    description: 'SLT Pilates studio barre serving Manhattan fitness clients',
  },
  {
    id: 'pl-chicago',
    name: 'Club Pilates Chicago Studio Barre',
    lat: 41.878,
    lng: -87.63,
    status: 'moderate',
    value: 70,
    ...
    trend: 'up' as const,
    description: 'Club Pilates studio barre serving Loop district fitness clients',
  },
  {
    id: 'pl-seattle',
    name: 'Pure Pilates Seattle Studio Barre',
    lat: 47.606,
    lng: -122.332,
    status: 'warning',
    value: 62,
    ...
    trend: 'down' as const,
    description: 'Pure Pilates studio barre serving Capitol Hill fitness clients',
  },
]
...
export function PilatesStudioBarreMonitor() {
  const state = useMapStore((s) => s.pilatesStudioBarre)
  const setState = useMapStore((s) => s.setPilatesStudioBarre)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-400 to-rose-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#11088;</span>
          <h3 className="text-sm font-semibold text-white">Pilates Studio Barre</h3>
        </div>
