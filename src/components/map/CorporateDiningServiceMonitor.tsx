...
const SAMPLE_LOCATIONS = [
  {
    id: 'cds-guckenheimer',
    name: 'Guckenheimer San Mateo CA',
    lat: 37.5630,
    lng: -122.3255,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 5.8,
    skusInStock: 1800,
    flagshipLines: 'Guckenheimer, MyKitchen, Bright Bites, Chef\'d',
    trend: 'up' as const,
    description: 'Guckenheimer San Mateo CA HQ corporate café operator, 720 daily tech-campus diners with 1,800 SKUs; chef-driven onsite restaurant concepts',
  },
  {
    id: 'cds-eurest',
    name: 'Eurest Corporate Dining Charlotte NC',
    lat: 35.2271,
    lng: -80.8431,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 5.1,
    skusInStock: 1650,
    flagshipLines: 'Eurest, Compass, Foodbuy, Touchpoint',
    trend: 'up' as const,
    description: 'Eurest Corporate Dining Charlotte NC regional HQ, 670 daily corporate diners with 1,650 SKUs; Compass Group B&I foodservice division',
  },
  {
    id: 'cds-abm',
    name: 'ABM Dining Services New York NY',
    lat: 40.7128,
    lng: -74.0060,
    status: 'moderate',
    value: 76,
    ...
    monthlyRevenue: 4.2,
    skusInStock: 1400,
    flagshipLines: 'ABM, Cuisine Solutions, ChefEx, MarketTable',
    trend: 'stable' as const,
    description: 'ABM Dining Services New York NY corporate catering, 540 daily customers with 1,400 SKUs; managed workplace hospitality and executive dining',
  },
  {
    id: 'cds-compass-corp',
    name: 'Compass Corporate Charlotte NC',
    lat: 35.2271,
    lng: -80.8431,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 6.9,
    skusInStock: 2200,
    flagshipLines: 'Compass, Bon Appétit, Canteen, Flik',
    trend: 'up' as const,
    description: 'Compass Group Corporate Dining Charlotte NC HQ, 890 daily enterprise café diners with 2,200 SKUs; parent of Bon Appétit Management and Flik Hospitality',
  },
]
...
export function CorporateDiningServiceMonitor() {
  const state = useMapStore((s) => s.corporateDiningService)
  const setState = useMapStore((s) => s.setCorporateDiningService)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-700 to-teal-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Corporate Dining Service</h3>
        </div>
