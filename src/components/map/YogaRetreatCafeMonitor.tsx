...
const SAMPLE_LOCATIONS = [
  {
    id: 'yr-bigsur',
    name: 'Esalen Institute Big Sur Yoga Retreat Cafe',
    lat: 36.258,
    lng: -121.798,
    status: 'stable',
    value: 88,
    ...
    trend: 'up' as const,
    description: 'Esalen Institute yoga retreat cafe serving Big Sur coast retreatants',
  },
  {
    id: 'yr-kripalu',
    name: 'Kripalu Yoga Retreat Cafe',
    lat: 42.29,
    lng: -73.322,
    status: 'stable',
    value: 90,
    ...
    description: 'Kripalu yoga retreat cafe serving Berkshire Hills retreatants',
  },
  {
    id: 'yr-sivananda',
    name: 'Sivananda Yoga Retreat Cafe',
    lat: 26.533,
    lng: -78.694,
    status: 'moderate',
    value: 72,
    ...
    flagshipLines: 'Green Smoothies,Herbal Tea,Quinoa Bowls,Snacks',
    trend: 'up' as const,
    description: 'Sivananda yoga retreat cafe serving Caribbean retreatants',
  },
  {
    id: 'yr-mountmadonna',
    name: 'Mount Madonna Yoga Retreat Cafe',
    lat: 36.898,
    lng: -121.746,
    status: 'warning',
    value: 58,
    ...
    monthlyRevenue: 0.5,
    skusInStock: 45,
    flagshipLines: 'Green Smoothies,Herbal Tea,Grain Bowls,Snacks',
    trend: 'down' as const,
    description: 'Mount Madonna yoga retreat cafe serving Santa Cruz Mountains retreatants',
  },
]
...
export function YogaRetreatCafeMonitor() {
  const state = useMapStore((s) => s.yogaRetreatCafe)
  const setState = useMapStore((s) => s.setYogaRetreatCafe)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-500 to-teal-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#127807;</span>
          <h3 className="text-sm font-semibold text-white">Yoga Retreat Cafe</h3>
        </div>
