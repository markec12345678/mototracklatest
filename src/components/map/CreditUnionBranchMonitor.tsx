...
const SAMPLE_LOCATIONS = [
  {
    id: 'cu-madison',
    name: 'UW Credit Union Madison WI',
    lat: 43.073,
    lng: -89.401,
    status: 'stable',
    value: 80,
    ...
    monthlyRevenue: 1.8,
    skusInStock: 44,
    flagshipLines: 'Auto Loans,Mortgages,Checking,Savings',
    trend: 'up' as const,
    description: 'UW Credit Union Madison WI flagship branch near University of Wisconsin campus, 290 daily members with 44 financial products; member-owned cooperative since 1931',
  },
  {
    id: 'cu-raleigh',
    name: 'Coastal Credit Union Raleigh NC',
    lat: 35.779,
    lng: -78.638,
    status: 'stable',
    value: 75,
    ...
    monthlyRevenue: 1.5,
    skusInStock: 38,
    flagshipLines: 'Auto Loans,Mortgages,Checking,Credit Cards',
    trend: 'stable' as const,
    description: 'Coastal Credit Union Raleigh NC headquarters branch, 240 daily members with 38 financial products; member-owned serving the Triangle since 1967',
  },
  {
    id: 'cu-seattle',
    name: 'BECU Seattle WA',
    lat: 47.461,
    lng: -122.255,
    status: 'moderate',
    value: 72,
    ...
    flagshipLines: 'Auto Loans,Mortgages,Checking,Savings',
    trend: 'up' as const,
    description: 'BECU Tukwila Seattle WA flagship branch, 360 daily members with 52 financial products; largest credit union in Washington state serving Boeing employees',
  },
  {
    id: 'cu-austin',
    name: 'A+ Federal Credit Union Austin TX',
    lat: 30.267,
    lng: -97.743,
    status: 'stable',
    value: 76,
    ...
    flagshipLines: 'Auto Loans,Mortgages,Checking,Savings',
    trend: 'stable' as const,
    description: 'A+ Federal Credit Union Austin TX main branch, 210 daily members with 36 financial products; member-owned serving Austin ISD educators and community since 1949',
  },
]
...
export function CreditUnionBranchMonitor() {
  const state = useMapStore((s) => s.creditUnionBranch)
  const setState = useMapStore((s) => s.setCreditUnionBranch)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-green-600 to-emerald-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Credit Union Branch</h3>
        </div>
