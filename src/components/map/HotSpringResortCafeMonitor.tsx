...
const SAMPLE_LOCATIONS = [
  {
    id: 'hs-quinn',
    name: 'Quinn Hot Springs Resort Cafe, Quinn MT',
    lat: 46.734,
    lng: -112.137,
    status: 'stable',
    value: 85,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 62,
    flagshipLines: 'Coffee, Herbal Tea, Sandwiches, Soup',
    trend: 'up' as const,
    description: 'Quinn Hot Springs resort cafe serving Rocky Mountain Front geothermal guests',
  },
  {
    id: 'hs-chena',
    name: 'Chena Hot Springs Resort Cafe, Fairbanks AK',
    lat: 64.873,
    lng: -146.347,
    status: 'moderate',
    value: 70,
    ...
    monthlyRevenue: 0.6,
    skusInStock: 55,
    flagshipLines: 'Coffee, Hot Cocoa, Sandwiches, Snacks',
    trend: 'stable' as const,
    description: 'Chena Hot Springs resort cafe serving Interior Alaska aurora watchers',
  },
  {
    id: 'hs-glenwood',
    name: 'Glenwood Hot Springs Resort Cafe, Glenwood Springs CO',
    lat: 39.547,
    lng: -107.324,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 1.1,
    skusInStock: 88,
    flagshipLines: 'Coffee, Smoothies, Sandwiches, Soup',
    trend: 'up' as const,
    description: 'Glenwood Hot Springs resort cafe serving Colorado River geothermal guests',
  },
  {
    id: 'hs-icelandic',
    name: 'Icelandic Hot Springs Resort Cafe, Idaho Springs CO',
    lat: 39.741,
    lng: -105.513,
    status: 'warning',
    value: 55,
    ...
    trend: 'down' as const,
    description: 'Indian Springs resort cafe serving Mount Evans Canyon geothermal guests',
  },
]
...
export function HotSpringResortCafeMonitor() {
  const state = useMapStore((s) => s.hotSpringResortCafe)
  const setState = useMapStore((s) => s.setHotSpringResortCafe)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-rose-500 to-orange-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#128293;</span>
          <h3 className="text-sm font-semibold text-white">Hot Spring Resort Cafe</h3>
        </div>
