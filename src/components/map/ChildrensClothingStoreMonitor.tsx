...
const SAMPLE_LOCATIONS = [
  {
    id: 'cc-gapkids',
    name: 'Gap Kids San Francisco CA',
    lat: 37.789,
    lng: -122.401,
    status: 'moderate',
    value: 70,
    ...
    monthlyRevenue: 0.9,
    skusInStock: 2800,
    flagshipLines: 'Baby, Toddler, Kids, Uniforms',
    trend: 'down' as const,
    description: 'Gap Kids San Francisco CA, 180 daily customers with 2,800 SKUs; classic American children\'s casual basics',
  },
  {
    id: 'cc-carters',
    name: "Carter's Atlanta GA",
    lat: 33.849,
    lng: -84.361,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 1.6,
    skusInStock: 5400,
    flagshipLines: 'Little Planet, OshKosh, Skip Hop, Simple Joys',
    trend: 'up' as const,
    description: "Carter's Atlanta GA HQ flagship, 240 daily customers with 5,400 SKUs; #1 baby & children's apparel brand in America",
  },
  {
    id: 'cc-childrensplace',
    name: 'The Children\'s Place Secaucus NJ',
    lat: 40.789,
    lng: -74.063,
    status: 'moderate',
    value: 72,
    ...
    monthlyRevenue: 1.2,
    skusInStock: 4100,
    flagshipLines: 'Baby Place, Place, Gymboree, Sugar & Jade',
    trend: 'stable' as const,
    description: "The Children's Place Secaucus NJ HQ, 195 daily customers with 4,100 SKUs; specialty children's apparel retailer",
  },
  {
    id: 'cc-gymboree',
    name: 'Gymboree San Francisco CA',
    lat: 37.789,
    lng: -122.401,
    status: 'warning',
    value: 60,
    ...
    monthlyRevenue: 0.5,
    skusInStock: 2200,
    flagshipLines: 'Play & Music, Kids, Baby, Accessories',
    trend: 'down' as const,
    description: 'Gymboree San Francisco CA flagship, 90 daily customers with 2,200 SKUs; revived under Children\'s Place ownership',
  },
]
...
export function ChildrensClothingStoreMonitor() {
  const state = useMapStore((s) => s.childrensClothingStore)
  const setState = useMapStore((s) => s.setChildrensClothingStore)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-yellow-500 to-amber-600">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Children&apos;s Clothing Store</h3>
        </div>
