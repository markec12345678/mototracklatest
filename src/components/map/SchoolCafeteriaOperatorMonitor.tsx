...
const SAMPLE_LOCATIONS = [
  {
    id: 'sc-sodexo-magic',
    name: 'SodexoMagic School Dining Atlanta GA',
    lat: 33.749,
    lng: -84.388,
    status: 'stable',
    value: 92,
    dailyCustomers: 48000,
    monthlyRevenue: 6.8,
    skusInStock: 2400,
    flagshipLines: 'K-12 Meals, Nutrition Standards, Allergen-Free',
    trend: 'up' as const,
    description: 'Major US K-12 school food service management company',
  },
  {
    id: 'sc-chartwells',
    name: 'Chartwells K12 Rye Brook NY',
    lat: 41.0095,
    lng: -73.6851,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 5.4,
    skusInStock: 2100,
    flagshipLines: 'School Cafeterias, Catering, Mobile Ordering',
    trend: 'up' as const,
    description: 'Compass Group subsidiary serving school districts nationwide',
  },
  {
    id: 'sc-aramark',
    name: 'Aramark Education Philadelphia PA',
    lat: 39.9526,
    lng: -75.1652,
    status: 'moderate',
    value: 80,
    ...
    monthlyRevenue: 4.6,
    skusInStock: 1900,
    flagshipLines: 'K-12 Dining, Higher Education, Vending',
    trend: 'flat' as const,
    description: 'Major education food service provider across US schools',
  },
  {
    id: 'sc-nyc-food',
    name: 'NYC Department of Education SchoolFood Long Island City NY',
    lat: 40.7484,
    lng: -73.944,
    status: 'warning',
    value: 76,
    dailyCustomers: 880000,
    monthlyRevenue: 28.4,
    skusInStock: 8400,
    flagshipLines: 'Breakfast, Lunch, Supper, Summer Meals',
    trend: 'down' as const,
    description: 'Largest school food authority in the US serving 1.1M students',
  },
]
...
export function SchoolCafeteriaOperatorMonitor() {
  const state = useMapStore((s) => s.schoolCafeteriaOperator)
  const setState = useMapStore((s) => s.setSchoolCafeteriaOperator)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-teal-700 to-cyan-800">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#127823;</span>
          <h3 className="text-sm font-semibold text-white">School Cafeteria Operator</h3>
        </div>
