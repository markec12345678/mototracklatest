...
const SAMPLE_LOCATIONS = [
  {
    id: 'br-anheuser-busch',
    name: 'Anheuser-Busch St. Louis MO',
    lat: 38.627,
    lng: -90.1994,
    status: 'stable',
    value: 92,
    ...
    monthlyRevenue: 18.5,
    skusInStock: 540,
    flagshipLines: 'Budweiser, Michelob, Busch, Stella Artois',
    trend: 'up' as const,
    description: 'Anheuser-Busch St. Louis MO HQ brewery and tour center, 2,200 daily taproom and tour visitors with 540 branded SKUs; largest US brewer since 1852',
  },
  {
    id: 'br-sierra-nevada',
    name: 'Sierra Nevada Brewing Chico CA',
    lat: 39.7285,
    lng: -121.8375,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 6.4,
    skusInStock: 210,
    flagshipLines: 'Pale Ale, Hazy Little Thing, Torpedo, Porter',
    trend: 'up' as const,
    description: 'Sierra Nevada Brewing Chico CA flagship taproom, 780 daily visitors with 210 SKUs; pioneering US craft brewery founded 1979',
  },
  {
    id: 'br-boston-beer',
    name: 'Boston Beer Company Boston MA',
    lat: 42.3601,
    lng: -71.0589,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 7.8,
    skusInStock: 240,
    flagshipLines: 'Samuel Adams, Angry Orchard, Truly, Dogfish Head',
    trend: 'up' as const,
    description: 'Boston Beer Company Boston MA HQ and taproom, 950 daily visitors with 240 SKUs; second-largest US craft brewer and hard seltzer pioneer',
  },
  {
    id: 'br-dogfish',
    name: 'Dogfish Head Craft Brewery Milton DE',
    lat: 38.7775,
    lng: -75.3091,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 2.9,
    skusInStock: 120,
    flagshipLines: '60 Minute, 90 Minute, Seaquench, Punkin',
    trend: 'stable' as const,
    description: 'Dogfish Head Craft Brewery Milton DE taproom and tours, 340 daily visitors with 120 SKUs; off-centered ales since 1995, now Boston Beer subsidiary',
  },
]
...
export function BreweryTaproomMonitor() {
  const state = useMapStore((s) => s.breweryTaproom)
  const setState = useMapStore((s) => s.setBreweryTaproom)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-700 to-orange-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Brewery &amp; Taproom</h3>
        </div>
