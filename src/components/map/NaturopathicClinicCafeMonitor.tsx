...
const SAMPLE_LOCATIONS = [
  {
    id: 'na-seattle',
    name: 'Bastyr Naturopathic Clinic Seattle Cafe',
    lat: 47.606,
    lng: -122.332,
    status: 'stable',
    value: 76,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 58,
    flagshipLines: 'Green Smoothies,Herbal Tea,Quinoa Bowls,Snacks',
    trend: 'up' as const,
    description: 'Bastyr Naturopathic Clinic Seattle cafe serving Capitol Hill natural medicine clients',
  },
  {
    id: 'na-portland',
    name: 'National College Naturopathic Clinic Portland Cafe',
    lat: 45.505,
    lng: -122.685,
    status: 'stable',
    value: 74,
    ...
    monthlyRevenue: 0.6,
    skusInStock: 52,
    flagshipLines: 'Green Juice,Herbal Tea,Grain Bowls,Snacks',
    trend: 'stable' as const,
    description: 'National College Naturopathic Clinic Portland cafe serving Hawthorne District natural medicine clients',
  },
  {
    id: 'na-phoenix',
    name: 'Southwest Naturopathic Clinic Phoenix Cafe',
    lat: 33.448,
    lng: -112.074,
    status: 'moderate',
    value: 66,
    ...
    flagshipLines: 'Green Smoothies,Herbal Tea,Quinoa Bowls,Snacks',
    trend: 'up' as const,
    description: 'Southwest Naturopathic Clinic Phoenix cafe serving Central Avenue natural medicine clients',
  },
  {
    id: 'na-austin',
    name: 'Austin Naturopathic Clinic Cafe',
    lat: 30.272,
    lng: -97.743,
    status: 'warning',
    value: 60,
    ...
    monthlyRevenue: 0.5,
    skusInStock: 45,
    flagshipLines: 'Kombucha,Herbal Tea,Grain Bowls,Snacks',
    trend: 'down' as const,
    description: 'Austin Naturopathic Clinic cafe serving East Austin natural medicine clients',
  },
]
...
export function NaturopathicClinicCafeMonitor() {
  const state = useMapStore((s) => s.naturopathicClinicCafe)
  const setState = useMapStore((s) => s.setNaturopathicClinicCafe)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-green-500 to-emerald-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#127807;</span>
          <h3 className="text-sm font-semibold text-white">Naturopathic Clinic Cafe</h3>
        </div>
