...
const SAMPLE_LOCATIONS = [
  {
    id: 'ts-davidson',
    name: 'Rishi Tea & Botanicals Milwaukee WI HQ',
    lat: 43.039,
    lng: -87.907,
    status: 'stable',
    value: 82,
    ...
    monthlyRevenue: 0.62,
    skusInStock: 1200,
    flagshipLines: 'Rishi, Ancient Emerald Lily, Earl Grey, Matcha',
    trend: 'up' as const,
    description: 'Rishi Tea & Botanicals Milwaukee WI HQ, 145 daily customers with 1,200 SKUs of loose-leaf teas and botanicals; direct-trade organic tea importer',
  },
  {
    id: 'ts-penzeys',
    name: "Penzeys Spices Wauwatosa WI HQ",
    lat: 43.050,
    lng: -87.996,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 2400,
    flagshipLines: 'Penzeys, Mural of Flavor, Fox Point, Sandwich Sprinkle',
    trend: 'up' as const,
    description: 'Penzeys Spices Wauwatosa WI HQ flagship, 380 daily customers with 2,400 SKUs; mail-order spice retailer with retail stores nationwide',
  },
  {
    id: 'ts-savory',
    name: 'The Savory Spice Denver CO',
    lat: 39.739,
    lng: -104.990,
    status: 'moderate',
    value: 71,
    ...
    monthlyRevenue: 0.84,
    skusInStock: 1800,
    flagshipLines: 'Savory, Summit County, Greek, Turkish, BBQ',
    trend: 'stable' as const,
    description: 'The Savory Spice Denver CO flagship, 220 daily customers with 1,800 SKUs; Colorado-based spice shop chain with custom blends',
  },
  {
    id: 'ts-mccormick',
    name: 'McCormick Spice Hunt Valley MD HQ',
    lat: 39.490,
    lng: -76.657,
    status: 'warning',
    value: 58,
    ...
    monthlyRevenue: 0.42,
    skusInStock: 980,
    flagshipLines: 'McCormick, Gourmet, Grill Mates, Lawry',
    trend: 'down' as const,
    description: 'McCormick Spice Hunt Valley MD HQ outlet store, 95 daily customers with 980 SKUs; consumer spice giant with small factory store footprint',
  },
]
...
export function TeaSpiceMerchantMonitor() {
  const state = useMapStore((s) => s.teaSpiceMerchant)
  const setState = useMapStore((s) => s.setTeaSpiceMerchant)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-700 to-teal-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Tea &amp; Spice Merchant</h3>
        </div>
