...
const SAMPLE_LOCATIONS = [
  {
    id: 'rf-losangeles',
    name: 'Reflexology Lounge Los Angeles Cafe',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 75,
    ...
    trend: 'up' as const,
    description: 'Reflexology Lounge Los Angeles cafe serving West Hollywood foot therapy clients',
  },
  {
    id: 'rf-newyork',
    name: 'Reflexology Lounge New York Cafe',
    lat: 40.728,
    lng: -74.001,
    status: 'moderate',
    value: 78,
    ...
    description: 'Reflexology Lounge New York cafe serving Manhattan foot therapy clients',
  },
  {
    id: 'rf-sanfrancisco',
    name: 'Reflexology Lounge San Francisco Cafe',
    lat: 37.778,
    lng: -122.419,
    status: 'stable',
    value: 72,
    ...
    trend: 'up' as const,
    description: 'Reflexology Lounge San Francisco cafe serving Mission District foot therapy clients',
  },
  {
    id: 'rf-austin',
    name: 'Reflexology Lounge Austin Cafe',
    lat: 30.272,
    lng: -97.743,
    status: 'warning',
    value: 68,
    ...
    trend: 'down' as const,
    description: 'Reflexology Lounge Austin cafe serving East Austin foot therapy clients',
  },
]
...
export function ReflexologyLoungeCafeMonitor() {
  const state = useMapStore((s) => s.reflexologyLoungeCafe)
  const setState = useMapStore((s) => s.setReflexologyLoungeCafe)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-500 to-teal-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Reflexology Lounge Cafe</h3>
        </div>
