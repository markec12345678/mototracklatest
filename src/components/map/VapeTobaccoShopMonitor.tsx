...
const SAMPLE_LOCATIONS = [
  {
    id: 'vt-avail-vapor',
    name: 'Avail Vapor Richmond VA HQ',
    lat: 37.540,
    lng: -77.436,
    status: 'stable',
    value: 72,
    ...
    monthlyRevenue: 0.42,
    skusInStock: 1200,
    flagshipLines: 'Avail, Naked 100, Vaporesso, Smok',
    trend: 'up' as const,
    description: 'Avail Vapor Richmond VA HQ flagship, 180 daily customers with 1,200 SKUs of e-liquids, mods and pods; Mid-Atlantic vape retail pioneer',
  },
  {
    id: 'vt-vaporfi',
    name: 'VaporFi Miami FL Flagship',
    lat: 25.790,
    lng: -80.130,
    status: 'moderate',
    value: 64,
    ...
    monthlyRevenue: 0.31,
    skusInStock: 980,
    flagshipLines: 'VaporFi, Halo, VAPE STIK, Grand Reserve',
    trend: 'stable' as const,
    description: 'VaporFi Miami FL flagship superstore, 140 daily customers with 980 SKUs; custom juice bar and device testing lounge',
  },
  {
    id: 'vt-vape-dojo',
    name: 'Vape Dojo Los Angeles CA',
    lat: 34.052,
    lng: -118.243,
    status: 'warning',
    value: 58,
    ...
    monthlyRevenue: 0.22,
    skusInStock: 760,
    flagshipLines: 'Vape Dojo, Air Factory, Jam Monster',
    trend: 'down' as const,
    description: 'Vape Dojo Los Angeles CA store, 95 daily customers with 760 SKUs; regulatory pressure on flavored products impacting foot traffic',
  },
  {
    id: 'vt-mistic',
    name: 'Mistic Ecigs Reston VA',
    lat: 38.958,
    lng: -77.357,
    status: 'critical',
    value: 41,
    ...
    monthlyRevenue: 0.14,
    skusInStock: 540,
    flagshipLines: 'Mistic, HAUS, Bridge, NJOY',
    trend: 'down' as const,
    description: 'Mistic Ecigs Reston VA outlet, 60 daily customers with 540 SKUs; cigalike segment declining as pod systems dominate',
  },
]
...
export function VapeTobaccoShopMonitor() {
  const state = useMapStore((s) => s.vapeTobaccoShop)
  const setState = useMapStore((s) => s.setVapeTobaccoShop)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-violet-700 to-purple-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Vape &amp; Tobacco Shop</h3>
        </div>
