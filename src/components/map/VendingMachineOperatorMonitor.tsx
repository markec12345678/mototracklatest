...
const SAMPLE_LOCATIONS = [
  {
    id: 'vm-canteen',
    name: 'Canteen Vending Services Charlotte NC HQ',
    lat: 35.2271,
    lng: -80.8431,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 2.4,
    skusInStock: 800,
    flagshipLines: 'Snacks, Beverages, Fresh Food, Coffee',
    trend: 'up' as const,
    description: 'Largest US vending operator with 10000+ machines',
  },
  {
    id: 'vm-five-star',
    name: 'Five Star Vending Atlanta GA',
    lat: 33.749,
    lng: -84.388,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 1.8,
    skusInStock: 620,
    flagshipLines: 'Soda, Snacks, Healthy Options',
    trend: 'up' as const,
    description: 'Regional vending operator across the Southeast',
  },
  {
    id: 'vm-avanti',
    name: 'Avanti Markets Bellevue WA',
    lat: 47.6101,
    lng: -122.2015,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 540,
    flagshipLines: 'Micro Markets, Fresh Meals, Grab-n-Go',
    trend: 'flat' as const,
    description: 'Unattended micro-market leader on the West Coast',
  },
  {
    id: 'vm-all-star',
    name: 'All Star Vending Dallas TX',
    lat: 32.7767,
    lng: -96.797,
    status: 'warning',
    value: 72,
    ...
    monthlyRevenue: 0.92,
    skusInStock: 380,
    flagshipLines: 'Vending, Pantry Service, Office Coffee',
    trend: 'down' as const,
    description: 'Independent vending operator in Texas',
  },
]
...
export function VendingMachineOperatorMonitor() {
  const state = useMapStore((s) => s.vendingMachineOperator)
  const setState = useMapStore((s) => s.setVendingMachineOperator)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-700 to-orange-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Vending Machine Operator</h3>
        </div>
