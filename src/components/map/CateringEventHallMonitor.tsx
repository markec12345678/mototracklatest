...
const SAMPLE_LOCATIONS = [
  {
    id: 'ca-wolfgang-puck',
    name: 'Wolfgang Puck Catering Los Angeles CA',
    lat: 34.0901,
    lng: -118.3617,
    status: 'stable',
    value: 92,
    ...
    monthlyRevenue: 1.8,
    skusInStock: 320,
    flagshipLines: 'Gala Dinners, Weddings, Corporate Events',
    trend: 'up' as const,
    description: 'Celebrity chef catering for Hollywood premieres and galas',
  },
  {
    id: 'ca-great-performances',
    name: 'Great Performances NYC Hudson Yards',
    lat: 40.7536,
    lng: -74.0014,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 2.1,
    skusInStock: 280,
    flagshipLines: 'Cultural Events, Weddings, Brand Activations',
    trend: 'up' as const,
    description: 'NYCs premier catering company with own organic farm',
  },
  {
    id: 'ca-legendary',
    name: 'Legendary Baking & Catering Chicago IL',
    lat: 41.8781,
    lng: -87.6298,
    status: 'moderate',
    value: 78,
    ...
    monthlyRevenue: 1.2,
    skusInStock: 240,
    flagshipLines: 'Corporate Catering, Private Events, Drop-off',
    trend: 'flat' as const,
    description: 'Midwest corporate catering specialist since 1985',
  },
  {
    id: 'ca-paula-ledyard',
    name: 'Paula LeDuc Fine Catering Napa CA',
    lat: 38.2975,
    lng: -122.2869,
    status: 'warning',
    value: 76,
    ...
    monthlyRevenue: 1.0,
    skusInStock: 200,
    flagshipLines: 'Wine Country Weddings, Estate Events, Farm-to-Table',
    trend: 'down' as const,
    description: "Napa Valley's leading estate event caterer",
  },
]
...
export function CateringEventHallMonitor() {
  const state = useMapStore((s) => s.cateringEventHall)
  const setState = useMapStore((s) => s.setCateringEventHall)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-rose-700 to-pink-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Catering &amp; Event Hall</h3>
        </div>
