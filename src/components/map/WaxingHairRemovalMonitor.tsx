...
const SAMPLE_LOCATIONS = [
  {
    id: 'wh-phoenix',
    name: 'Waxing Hair Removal Phoenix',
    lat: 33.448,
    lng: -112.074,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 55,
    flagshipLines: 'Brazilian Wax,Leg Wax,Underarm Wax,Threading',
    trend: 'up' as const,
    description: 'Waxing Hair Removal Phoenix studio in Scottsdale, 70 daily clients specializing in Brazilian wax and threading services',
  },
  {
    id: 'wh-austin',
    name: 'Waxing Hair Removal Austin',
    lat: 30.267,
    lng: -97.743,
    status: 'stable',
    value: 82,
    ...
    flagshipLines: 'Brazilian Wax,Leg Wax,Underarm Wax,Threading',
    trend: 'up' as const,
    description: 'Waxing Hair Removal Austin studio in South Congress, 65 daily clients offering full body waxing and threading',
  },
  {
    id: 'wh-sanfrancisco',
    name: 'Waxing Hair Removal San Francisco',
    lat: 37.778,
    lng: -122.419,
    status: 'moderate',
    value: 74,
    ...
    description: 'Waxing Hair Removal San Francisco studio in Mission District, 60 daily clients with sugaring and hard wax options',
  },
  {
    id: 'wh-orlando',
    name: 'Waxing Hair Removal Orlando',
    lat: 28.538,
    lng: -81.379,
    status: 'warning',
    value: 62,
    ...
    flagshipLines: 'Brazilian Wax,Leg Wax,Underarm Wax,Threading',
    trend: 'down' as const,
    description: 'Waxing Hair Removal Orlando studio near International Drive, 50 daily clients facing seasonal tourist demand swings',
  },
]
...
export function WaxingHairRemovalMonitor() {
  const state = useMapStore((s) => s.waxingHairRemoval)
  const setState = useMapStore((s) => s.setWaxingHairRemoval)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-orange-600 to-red-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Waxing Hair Removal</h3>
        </div>
