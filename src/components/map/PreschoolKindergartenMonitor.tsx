...
const SAMPLE_LOCATIONS = [
  {
    id: 'pk-kinder',
    name: 'KinderCare Learning Center Portland',
    lat: 45.523,
    lng: -122.676,
    status: 'stable',
    value: 90,
    childrenEnrolled: 142,
    capacity: 160,
    teachersOnDuty: 12,
    staffRatio: '1:8',
    ageRange: '6 weeks - 12 yrs',
    trend: 'up' as const,
    description: 'KinderCare Portland flagship with NAEYC accreditation, 142 children enrolled and 12 trained educators across infant through school-age programs',
  },
  {
    id: 'pk-goddard',
    name: 'The Goddard School Austin TX',
    lat: 30.267,
    lng: -97.743,
    status: 'stable',
    value: 86,
    childrenEnrolled: 128,
    capacity: 140,
    teachersOnDuty: 11,
    staffRatio: '1:7',
    ageRange: '6 weeks - 6 yrs',
    trend: 'stable' as const,
    description: 'Goddard School Austin play-based F.L.EX. curriculum with 128 enrolled, 11 degreed teachers and STEM enrichment for pre-K',
  },
  {
    id: 'pk-primrose',
    name: 'Primrose School Denver',
    lat: 39.762,
    lng: -104.880,
    status: 'moderate',
    value: 76,
    childrenEnrolled: 104,
    capacity: 130,
    teachersOnDuty: 9,
    staffRatio: '1:9',
    ageRange: '6 weeks - 12 yrs',
    trend: 'up' as const,
    description: 'Primrose Denver Balanced Learning curriculum with character development program, 104 children and waiting list for infant room',
  },
  {
    id: 'pk-discovery',
    name: 'Discovery Point Atlanta',
    lat: 33.767,
    lng: -84.420,
    status: 'warning',
    value: 60,
    ...
    ageRange: '6 weeks - 12 yrs',
    trend: 'down' as const,
    description: 'Discovery Point Atlanta facing staffing shortage post-pandemic, 78 of 120 enrolled with 7 teachers and reduced summer camp capacity',
  },
]
...
export function PreschoolKindergartenMonitor() {
  const state = useMapStore((s) => s.preschoolKindergarten)
  const setState = useMapStore((s) => s.setPreschoolKindergarten)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-yellow-500 to-amber-700">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Preschool & Kindergarten</h3>
        </div>
        ...
        {activeItem && (
          <div className="bg-slate-800/60 rounded p-2.5 border border-slate-700/50">
            ...
            <div className="mt-1.5 text-[10px] text-slate-500">
              ...
              &nbsp;&middot;&nbsp; Ratio {activeItem.staffRatio}, {activeItem.teachersOnDuty} teachers, {activeItem.childrenEnrolled}/{activeItem.capacity} kids
            </div>
          </div>
        )}
      </div>
