...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 2.8,
    skusInStock: 9800,
    flagshipLines: 'HP, Brother, Post-it, Avery, BIC',
    trend: 'stable' as const,
    description: 'Staples Framingham MA HQ flagship superstore, 620 daily customers with 9,800 SKUs; founding location of the office supply chain',
  },
  {
    id: 'os-officedepot',
    name: 'Office Depot Boca Raton FL HQ',
    lat: 26.368,
    lng: -80.124,
    status: 'stable',
    value: 79,
    ...
    monthlyRevenue: 2.1,
    skusInStock: 8200,
    flagshipLines: 'Office Depot, TUL, Foray, Ativa',
    trend: 'down' as const,
    description: 'Office Depot Boca Raton FL HQ store, 480 daily customers with 8,200 SKUs; merged with ODP Corp, footprint rationalization ongoing',
  },
  {
    id: 'os-officemax',
    name: 'OfficeMax Naperville IL',
    lat: 41.786,
    lng: -88.147,
    status: 'moderate',
    value: 68,
    ...
    monthlyRevenue: 1.3,
    skusInStock: 6400,
    flagshipLines: 'OfficeMax, WorkPro, TUL',
    trend: 'down' as const,
    description: 'OfficeMax Naperville IL flagship, 320 daily customers with 6,400 SKUs; legacy brand absorbed into ODP retail network',
  },
  {
    id: 'os-walmart-stationery',
    name: 'Walmart Stationery Bentonville AR',
    lat: 36.373,
    lng: -94.209,
    status: 'stable',
    value: 82,
    ...
    monthlyRevenue: 1.9,
    skusInStock: 4200,
    flagshipLines: 'Pendaflex, Mead, Five Star, Sharpie',
    trend: 'up' as const,
    description: 'Walmart Stationery section Bentonville AR supercenter, 1,850 daily customers with 4,200 SKUs; value-tier back-to-school leader',
  },
]
...
export function OfficeSupplyChainMonitor() {
  const state = useMapStore((s) => s.officeSupplyChain)
  const setState = useMapStore((s) => s.setOfficeSupplyChain)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-red-700 to-rose-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Office Supply Chain</h3>
        </div>
