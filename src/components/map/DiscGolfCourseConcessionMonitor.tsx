...
const SAMPLE_LOCATIONS = [
  {
    id: 'dg-maple-hill',
    name: 'Maple Hill Disc Golf Leominster MA',
    lat: 42.526,
    lng: -71.76,
    status: 'stable',
    value: 88,
    ...
    monthlyRevenue: 0.5,
    skusInStock: 68,
    flagshipLines: 'Hot Dogs, Beer, Water, Snacks',
    trend: 'up' as const,
    description: 'Maple Hill Disc Golf in Leominster MA, 180 daily customers with 68 SKUs; host of the MVP Open and a top-rated PDGA destination course',
  },
  {
    id: 'dg-winthrop',
    name: 'Winthrop University Course Rock Hill SC',
    lat: 34.925,
    lng: -81.025,
    status: 'stable',
    value: 90,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 85,
    flagshipLines: 'BBQ Plates, Sweet Tea, Gatorade, Discs',
    trend: 'up' as const,
    description: 'Winthrop University Disc Golf Course in Rock Hill SC, 220 daily customers with 85 SKUs; annual United States Disc Golf Championship venue',
  },
  {
    id: 'dg-idlewild',
    name: 'Idlewild Disc Golf Course Burlington KY',
    lat: 39.027,
    lng: -84.724,
    status: 'moderate',
    value: 72,
    ...
    monthlyRevenue: 0.4,
    skusInStock: 60,
    flagshipLines: 'Sandwiches, Coffee, Discs, Sunscreen',
    trend: 'stable' as const,
    description: 'Idlewild Disc Golf Course in Burlington KY, 160 daily customers with 60 SKUs; wooded championship layout hosting the Idlewild Open',
  },
  {
    id: 'dg-hornings',
    name: 'Hornings Hideout Disc Golf North Plains OR',
    lat: 45.694,
    lng: -122.989,
    status: 'warning',
    value: 64,
    ...
    monthlyRevenue: 0.4,
    skusInStock: 52,
    flagshipLines: 'Pizza, Beer, Water, Trail Mix',
    trend: 'down' as const,
    description: 'Hornings Hideout Disc Golf in North Plains OR, 140 daily customers with 52 SKUs; three-course complex in a wooded Pacific Northwest setting',
  },
]
...
export function DiscGolfCourseConcessionMonitor() {
  const state = useMapStore((s) => s.discGolfCourseConcession)
  const setState = useMapStore((s) => s.setDiscGolfCourseConcession)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-green-700 to-emerald-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Disc Golf Course Concession</h3>
        </div>
