...
const SAMPLE_LOCATIONS = [
  {
    ...
    monthlyRevenue: 3.2,
    skusInStock: 7600,
    flagshipLines: 'Patagonia, North Face, Garmin, Osprey',
    trend: 'up' as const,
    description: 'REI Co-op Kent WA HQ flagship, 480 daily customers with 7,600 SKUs spanning Patagonia, North Face, Garmin and Osprey',
  },
  {
    id: 'oa-cabelas',
    name: "Cabela's Sidney NE",
    lat: 41.142,
    lng: -102.978,
    status: 'stable',
    value: 86,
    ...
    monthlyRevenue: 2.6,
    skusInStock: 9200,
    flagshipLines: 'Bass Pro, Savage, Yeti, Carhartt',
    trend: 'stable' as const,
    description: "Cabela's Sidney NE flagship with 9,200 SKUs, 390 daily customers; Bass Pro subsidiary with strong hunting/fishing heritage",
  },
  {
    id: 'oa-basspro',
    name: 'Bass Pro Shops Springfield MO',
    lat: 37.181,
    lng: -93.219,
    status: 'stable',
    value: 90,
    ...
    monthlyRevenue: 3.5,
    skusInStock: 10500,
    flagshipLines: 'Tracker Boats, Johnny Morris, Abu Garcia',
    trend: 'up' as const,
    description: 'Bass Pro Shops Springfield MO HQ Pyramid store, 560 daily customers with 10,500 SKUs and the iconic indoor swamp',
  },
  {
    id: 'oa-backcountry',
    name: 'Backcountry Park City UT',
    lat: 40.646,
    lng: -111.498,
    status: 'moderate',
    value: 72,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 4200,
    flagshipLines: 'Arc\'teryx, Black Diamond, Salomon',
    trend: 'stable' as const,
    description: 'Backcountry Park City UT HQ storefront, 110 walk-in daily customers with 4,200 SKUs; online-first outdoor specialty retailer',
  },
]
...
export function OutdoorAdventureGearMonitor() {
  const state = useMapStore((s) => s.outdoorAdventureGear)
  const setState = useMapStore((s) => s.setOutdoorAdventureGear)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-green-700 to-emerald-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Outdoor Adventure Gear</h3>
        </div>
