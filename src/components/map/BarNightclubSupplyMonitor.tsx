...
const SAMPLE_LOCATIONS = [
  {
    id: 'bns-barproducts',
    name: 'BarProducts.com St. Petersburg FL',
    lat: 27.7676,
    lng: -82.6403,
    status: 'stable',
    value: 80,
    ...
    monthlyRevenue: 3.2,
    skusInStock: 1800,
    flagshipLines: 'BarProducts, Muddler, Mixology, Barmaid',
    trend: 'up' as const,
    description: 'BarProducts.com St. Petersburg FL online bar supply, 420 daily orders with 1,800 SKUs; barware, mixology tools and glassware direct-to-venue',
  },
  {
    id: 'bns-kaplan',
    name: 'Kaplan Co New York NY',
    lat: 40.7128,
    lng: -74.006,
    status: 'stable',
    value: 82,
    ...
    monthlyRevenue: 2.9,
    skusInStock: 1600,
    flagshipLines: 'Kaplan, Barkeeper, Service Star, NiteLife',
    trend: 'up' as const,
    description: 'Kaplan Co New York NY bar and nightclub distributor, 380 daily orders with 1,600 SKUs; NYC hospitality supply since 1928',
  },
  {
    id: 'bns-lakeside',
    name: 'Lakeside Beverage Bloomfield CT',
    lat: 41.8262,
    lng: -72.7382,
    status: 'moderate',
    value: 74,
    ...
    monthlyRevenue: 2.4,
    skusInStock: 1300,
    flagshipLines: 'Lakeside, BarCraft, Pourfect, Nostalgia',
    trend: 'stable' as const,
    description: 'Lakeside Beverage Equipment Bloomfield CT bar supply, 290 daily orders with 1,300 SKUs; bar equipment, glassware and smallwares wholesaler',
  },
  {
    id: 'bns-barguys',
    name: 'Barguys Supply Dallas TX',
    lat: 32.7767,
    lng: -96.797,
    status: 'warning',
    value: 68,
    ...
    monthlyRevenue: 1.8,
    skusInStock: 950,
    flagshipLines: 'Barguys, PourTools, ShakeMate, GlowBar',
    trend: 'down' as const,
    description: 'Barguys Supply Dallas TX nightclub equipment distributor, 210 daily orders with 950 SKUs; regional bar and lounge specialist experiencing supply headwinds',
  },
]
...
export function BarNightclubSupplyMonitor() {
  const state = useMapStore((s) => s.barNightclubSupply)
  const setState = useMapStore((s) => s.setBarNightclubSupply)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-fuchsia-700 to-pink-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Bar &amp; Nightclub Supply</h3>
        </div>
