...
const SAMPLE_LOCATIONS = [
  {
    id: 'sb-losangeles',
    name: 'Sound Bath Los Angeles Lounge',
    lat: 34.052,
    lng: -118.244,
    status: 'stable',
    value: 84,
    ...
    trend: 'up' as const,
    description: 'Sound Bath Los Angeles lounge serving West Hollywood crystal bowl meditation clients',
  },
  {
    id: 'sb-newyork',
    name: 'Sound Healing New York Lounge',
    lat: 40.728,
    lng: -74.001,
    status: 'stable',
    value: 79,
    ...
    description: 'Sound Healing New York lounge serving Manhattan gong bath meditation clients',
  },
  {
    id: 'sb-sedona',
    name: 'Sedona Sound Bowl Lounge',
    lat: 34.87,
    lng: -111.761,
    status: 'moderate',
    value: 68,
    ...
    trend: 'up' as const,
    description: 'Sedona Sound Bowl lounge serving red rock crystal bowl meditation clients',
  },
  {
    id: 'sb-portland',
    name: 'Portland Sound Therapy Lounge',
    lat: 45.505,
    lng: -122.685,
    status: 'warning',
    value: 58,
    ...
    trend: 'down' as const,
    description: 'Portland Sound Therapy lounge serving Hawthorne District sound bath meditation clients',
  },
]
...
export function SoundBathMeditationLoungeMonitor() {
  const state = useMapStore((s) => s.soundBathMeditationLounge)
  const setState = useMapStore((s) => s.setSoundBathMeditationLounge)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-violet-500 to-purple-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#128276;</span>
          <h3 className="text-sm font-semibold text-white">Sound Bath Meditation Lounge</h3>
        </div>
