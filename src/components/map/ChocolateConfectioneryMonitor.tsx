...
const SAMPLE_LOCATIONS = [
  {
    id: 'cc-ghirardelli',
    name: 'Ghirardelli Chocolate San Francisco CA',
    lat: 37.805,
    lng: -122.414,
    status: 'stable',
    value: 89,
    ...
    monthlyRevenue: 2.2,
    skusInStock: 320,
    flagshipLines: 'Ghirardelli, Square, Bar, Premium Baking, Hot Cocoa',
    trend: 'stable' as const,
    description: 'Ghirardelli Chocolate San Francisco CA flagship, 680 daily customers with 320 SKUs; historic Ghirardelli Square ice cream and chocolate destination',
  },
  {
    id: 'cc-godiva',
    name: 'Godiva Chocolatier New York NY',
    lat: 40.758,
    lng: -73.985,
    status: 'moderate',
    value: 73,
    ...
    monthlyRevenue: 1.3,
    skusInStock: 240,
    flagshipLines: 'Godiva, Gold Box, Masterpieces, Truffles, Biscuit',
    trend: 'down' as const,
    description: 'Godiva Chocolatier New York NY flagship, 410 daily customers with 240 SKUs; Belgian premium chocolate with shrinking US retail footprint',
  },
  {
    id: 'cc-lindt',
    name: 'Lindt Chocolate Springtown PA',
    lat: 40.227,
    lng: -75.434,
    status: 'stable',
    value: 81,
    ...
    monthlyRevenue: 1.0,
    skusInStock: 280,
    flagshipLines: 'Lindt, Lindor, Excellence, Hello, GOLD BUNNY',
    trend: 'up' as const,
    description: 'Lindt Chocolate Springtown PA flagship shop, 320 daily customers with 280 SKUs; Swiss premium chocolate with US production facility',
  },
  {
    id: 'cc-see-candy',
    name: "See Candys San Francisco CA",
    lat: 37.789,
    lng: -122.401,
    status: 'warning',
    value: 66,
    ...
    monthlyRevenue: 0.78,
    skusInStock: 180,
    flagshipLines: 'See, Bridge Mix, Bordeaux, Milk Choc Pecan',
    trend: 'stable' as const,
    description: 'See Candys San Francisco CA flagship, 240 daily customers with 180 SKUs; California heritage confectioner with West Coast retail focus',
  },
]
...
export function ChocolateConfectioneryMonitor() {
  const state = useMapStore((s) => s.chocolateConfectionery)
  const setState = useMapStore((s) => s.setChocolateConfectionery)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-700 to-orange-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Chocolate &amp; Confectionery</h3>
        </div>
