...
const SAMPLE_LOCATIONS = [
  {
    id: 'ds-canyonranch',
    name: 'Canyon Ranch Day Spa Cafe, Tucson AZ',
    lat: 32.246,
    lng: -110.917,
    status: 'stable',
    value: 88,
    ...
    trend: 'up' as const,
    description: 'Canyon Ranch Tucson day spa cafe serving wellness retreat guests',
  },
  {
    id: 'ds-goldendoor',
    name: 'Golden Door Day Spa Cafe, Escondido CA',
    lat: 33.119,
    lng: -117.086,
    status: 'stable',
    value: 79,
    ...
    monthlyRevenue: 0.7,
    skusInStock: 58,
    flagshipLines: 'Green Juice,Herbal Tea,Sushi Bowls,Snacks',
    trend: 'stable' as const,
    description: 'Golden Door day spa cafe serving San Diego wellness retreat guests',
  },
  {
    id: 'ds-miraval',
    name: 'Miraval Austin Day Spa Cafe, Austin TX',
    lat: 30.272,
    lng: -97.743,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 0.8,
    skusInStock: 65,
    flagshipLines: 'Smoothies,Herbal Tea,Acai Bowls,Snacks',
    trend: 'up' as const,
    description: 'Miraval Austin day spa cafe serving Hill Country wellness retreat guests',
  },
  {
    id: 'ds-redmountain',
    name: 'Red Mountain Day Spa Cafe, Ivins UT',
    lat: 37.167,
    lng: -113.68,
    status: 'moderate',
    value: 71,
    ...
    flagshipLines: 'Green Smoothies,Herbal Tea,Quinoa Bowls,Snacks',
    trend: 'down' as const,
    description: 'Red Mountain day spa cafe serving southwest Utah wellness retreat guests',
  },
]
...
export function DaySpaCafeMonitor() {
  const state = useMapStore((s) => s.daySpaCafe)
  const setState = useMapStore((s) => s.setDaySpaCafe)
  ...
  return (
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-pink-500 to-rose-900">
        <div className="flex items-center gap-2">
          <span className="text-lg">&#127800;</span>
          <h3 className="text-sm font-semibold text-white">Day Spa Cafe</h3>
        </div>
