...
const SAMPLE_LOCATIONS = [
  {
    id: 'am-chicago',
    name: 'Midas Auto Service Chicago IL',
    lat: 41.878,
    lng: -87.630,
    status: 'stable',
    value: 84,
    ...
    monthlyRevenue: 1.4,
    skusInStock: 2100,
    flagshipLines: 'Brake Jobs, Engine Repair, Diagnostics, Tune-ups',
    trend: 'stable' as const,
    description: 'Midas Auto Service Chicago IL flagship shop, 92 vehicles serviced daily with 2,100 parts SKUs; full-service Midwest repair hub',
  },
  {
    id: 'am-houston',
    name: 'Pep Boys Houston TX',
    lat: 29.760,
    lng: -95.369,
    status: 'moderate',
    value: 68,
    ...
    flagshipLines: 'Brake Jobs, Engine Repair, Diagnostics, Tune-ups',
    trend: 'up' as const,
    description: 'Pep Boys Houston TX service center, 78 vehicles serviced daily with 1,800 parts SKUs; Gulf Coast fleet maintenance leader',
  },
  {
    id: 'am-phoenix',
    name: 'Firestone Complete Auto Phoenix AZ',
    lat: 33.448,
    lng: -112.074,
    status: 'warning',
    value: 54,
    ...
    flagshipLines: 'Brake Jobs, Engine Repair, Diagnostics, Tune-ups',
    trend: 'down' as const,
    description: 'Firestone Complete Auto Phoenix AZ, 65 vehicles serviced daily with 1,400 parts SKUs; desert heat drives A/C and cooling repairs',
  },
  {
    id: 'am-detroit',
    name: 'Meineke Car Care Detroit MI',
    lat: 42.331,
    lng: -83.046,
    status: 'critical',
    value: 38,
    ...
    flagshipLines: 'Brake Jobs, Engine Repair, Diagnostics, Tune-ups',
    trend: 'down' as const,
    description: 'Meineke Car Care Detroit MI, 44 vehicles serviced daily with 950 parts SKUs; Motor City legacy shop facing technician shortages',
  },
]
...
export function AutoMechanicShopMonitor() {
  const state = useMapStore((s) => s.autoMechanicShop)
  const setState = useMapStore((s) => s.setAutoMechanicShop)
    ...
    <Card className="fixed right-4 top-16 z-[60] w-[340px] max-h-[80vh] overflow-hidden flex flex-col p-0 bg-slate-900/95 border-slate-700 text-slate-100 backdrop-blur-md">
      <div className="flex items-center justify-between p-3 bg-gradient-to-r from-red-700 to-orange-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Auto Mechanic Shop</h3>
        </div>
